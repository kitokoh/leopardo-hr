...
## Instructions
```
Agis en tant qu'auditeur DevOps et documentation pour le projet Leopardo RH situé dans leopardo-hr (racine du dépôt, dossier courant).
...
Agis en tant qu'auditeur DevOps et documentation pour le projet Leopardo RH situé dans leopardo-hr (racine du dépôt git).
