 ...
 * masking the real signal — see docs/archive/PLAN_ACTION2/10_AUDIT_I18N_MULTILINGUE.md
...
function buildReport(results) {
  ...
  lines.push('masking the real debt (see `docs/archive/PLAN_ACTION2/10_AUDIT_I18N_MULTILINGUE.md` section 5).');
