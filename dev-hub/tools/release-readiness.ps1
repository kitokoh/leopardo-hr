...
Add-Check "Governance" "Launch API profile smoke present" ((Test-PathExists "dev-hub/tools/launch-api-profile-smoke.ps1") -and (Test-PathExists "docs/validation/LAUNCH_API_PROFILE_SMOKE_2026_06_06.md")) "Plan 72 API profile smoke script and report" "Restore Plan 72 API profile smoke before opening broad marketing traffic."
