...
Add-Check "Governance" "Launch workflow contracts present" ((Test-PathExists "dev-hub/tools/launch-workflow-contracts.json") -and (Test-PathExists "dev-hub/tools/validate-launch-workflows.ps1") -and (Test-PathExists "docs/archive/PLAN_ACTION/72_PLAN_WORKFLOWS_LANCEMENT_SURFACES.md")) "Plan 72 launch workflow manifest, validator and plan" "Restore Plan 72 launch workflow governance before marketing launch."
