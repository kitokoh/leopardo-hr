...
# #4391 — dédup #3756 (734d0c3ba) : la distribution auto main est portée
...
# Les assertions « auto trigger » suivent donc le workflow main dédié ;
# exiger `branches:` sur mobile-distribute.yml serait un faux positif (main
# rouge permanent depuis #3756).
Assert-Contains $mobileDistributeMain "branches:" "Deploy main mobile auto trigger"
Assert-Contains $mobileDistributeMain "front/mobile_apps/**" "Deploy main mobile auto trigger"
