...
## 📂 Contents
- [`../sdk/javascript`](../sdk/javascript): client SDK JavaScript généré (OpenAPI) — auth + CRUD. Généré localement via `make openapi-sync` (non committé depuis #7654).
- [`../sdk/python`](../sdk/python): client SDK Python généré (OpenAPI). Généré localement via `make openapi-sync` (non committé depuis #7654).
