...
class LeopardoClient:
    ...
    def post_employee_join_requests_by_joinrequest_approve(self, **kwargs):
        """Approuve une demande d’intégration"""
        return self.request("POST", "/employee-join-requests/{joinRequest}/approve", **kwargs)
    ...
    def patch_schedules_by_schedule(self, **kwargs):
        """Mettre à jour un planning (manager)"""
    ...
    def get_user_companies_directory(self, **kwargs):
        """Recherche les entreprises accessibles"""
        return self.request("GET", "/user/companies/directory", **kwargs)
    ...
    def get_user_employee_join_requests(self, **kwargs):
        """Liste les demandes d’intégration de l’utilisateur"""
        return self.request("GET", "/user/employee-join-requests", **kwargs)

    def post_user_employee_join_requests(self, **kwargs):
        """Demande à rejoindre une entreprise"""
        return self.request("POST", "/user/employee-join-requests", **kwargs)
    ...
    def get_user_job_application_notifications(self, **kwargs):
        """Liste les notifications de candidature"""
        return self.request("GET", "/user/job-application-notifications", **kwargs)

    def patch_user_job_application_notifications_read(self, **kwargs):
        """Marque comme lues les notifications de candidature"""
        return self.request("PATCH", "/user/job-application-notifications/read", **kwargs)

    def get_user_job_applications(self, **kwargs):
        """Liste l’historique des candidatures de l’utilisateur"""
        return self.request("GET", "/user/job-applications", **kwargs)

    def post_user_job_applications_by_companyslug_by_jobposting(self, **kwargs):
        """Dépose une candidature authentifiée"""
        return self.request("POST", "/user/job-applications/{companySlug}/{jobPosting}", **kwargs)

    def get_user_job_recommendations(self, **kwargs):
        """Retourne les offres recommandées au candidat"""
        return self.request("GET", "/user/job-recommendations", **kwargs)

    def put_user_job_search_profile(self, **kwargs):
        """Met à jour les préférences de recherche d’emploi"""
        return self.request("PUT", "/user/job-search-profile", **kwargs)

    def post_user_job_search_profile_resume(self, **kwargs):
        """Téléverse une version privée du CV"""
        return self.request("POST", "/user/job-search-profile/resume", **kwargs)
    ...
    def get_user_personal_onboarding(self, **kwargs):
        """Lit l’onboarding personnel de l’utilisateur"""
        return self.request("GET", "/user/personal-onboarding", **kwargs)

    def put_user_personal_onboarding(self, **kwargs):
        """Enregistre les statuts personnels cumulables"""
        return self.request("PUT", "/user/personal-onboarding", **kwargs)
