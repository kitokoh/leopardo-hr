...
export function createLeopardoClient({ baseUrl, token, fetchImpl = globalThis.fetch } = {}) {
  ...
  return {
    ...
    getAccountingJournalEntries(options = {}) {
    ...
    getAccountingPaymentOrders(options = {}) {
      return request("GET", "/accounting/payment-orders", options);
    },

    /** Créer un ordre de virement depuis un run de paie validé */
    postAccountingPaymentOrders(options = {}) {
      return request("POST", "/accounting/payment-orders", options);
    },

    /** Détail d'un ordre de virement */
    getAccountingPaymentOrdersByOrder(options = {}) {
      return request("GET", "/accounting/payment-orders/{order}", options);
    },

    /** Exécuter un ordre de virement (référence banque + date = rapprochement) */
    postAccountingPaymentOrdersByOrderExecute(options = {}) {
      return request("POST", "/accounting/payment-orders/{order}/execute", options);
    },

    /** Préparer un ordre de virement (génération de l'export banque) */
    postAccountingPaymentOrdersByOrderPrepare(options = {}) {
      return request("POST", "/accounting/payment-orders/{order}/prepare", options);
    },
