...
export function createLeopardoClient({ baseUrl, token, fetchImpl = globalThis.fetch } = {}) {
  ...
  return {
    ...
    getFuelStationCustomers(options = {}) {
      return request("GET", "/fuel-station/customers", options);
    },

    /** Creer ou synchroniser un client (manager, idempotent par external_id) */
    postFuelStationCustomers(options = {}) {
      return request("POST", "/fuel-station/customers", options);
    },

    /** Detail d'un client */
    getFuelStationCustomersByCustomer(options = {}) {
      return request("GET", "/fuel-station/customers/{customer}", options);
    },

    /** Modifier le consentement marketing (manager, RGPD) */
    putFuelStationCustomersByCustomerConsent(options = {}) {
      return request("PUT", "/fuel-station/customers/{customer}/consent", options);
    },

    /** Depenser des points de fidelite (manager) */
    postFuelStationCustomersByCustomerRedeem(options = {}) {
      return request("POST", "/fuel-station/customers/{customer}/redeem", options);
    },

    /** Lister les equipements (kind=pump|tank|meter) */
    getFuelStationEquipment(options = {}) {
      return request("GET", "/fuel-station/equipment", options);
    },

    /** Creer un equipement (manager, kind=pump|tank|meter) */
    postFuelStationEquipment(options = {}) {
      return request("POST", "/fuel-station/equipment", options);
    },

    /** Mettre a jour un equipement (manager) */
    putFuelStationEquipmentByKindById(options = {}) {
      return request("PUT", "/fuel-station/equipment/{kind}/{id}", options);
    },

    /** Export CSV des releves (manager, audite) */
    getFuelStationExportsReadings(options = {}) {
      return request("GET", "/fuel-station/exports/readings", options);
    },

    /** Export CSV des ventes (manager, audite) */
    getFuelStationExportsSales(options = {}) {
      return request("GET", "/fuel-station/exports/sales", options);
    },
    ...
    putFuelStationProductsByProduct(options = {}) {
      return request("PUT", "/fuel-station/products/{product}", options);
    },

    /** Anomalies de compteur (manager) */
    getFuelStationReportsAnomalies(options = {}) {
      return request("GET", "/fuel-station/reports/anomalies", options);
    },

    /** Ventes journalieres (manager) */
    getFuelStationReportsDailySales(options = {}) {
      return request("GET", "/fuel-station/reports/daily-sales", options);
    },
    ...
    getFuelStationSites(options = {}) {
      return request("GET", "/fuel-station/sites", options);
    },

    /** Creer un site operationnel (manager) */
    postFuelStationSites(options = {}) {
      return request("POST", "/fuel-station/sites", options);
    },

    /** Detail d'un site */
    getFuelStationSitesBySite(options = {}) {
      return request("GET", "/fuel-station/sites/{site}", options);
    },
    ...
    getFuelStationStockEntries(options = {}) {
      return request("GET", "/fuel-station/stock-entries", options);
    },

    /** Enregistrer une entree de stock (manager, idempotent) */
    postFuelStationStockEntries(options = {}) {
      return request("POST", "/fuel-station/stock-entries", options);
    },

    /** Niveau de stock calcule (manager) */
    getFuelStationStockLevel(options = {}) {
      return request("GET", "/fuel-station/stock/level", options);
    },

    /** Lancer un rapprochement station/jour (manager, idempotent) */
    postFuelStationStockReconcile(options = {}) {
      return request("POST", "/fuel-station/stock/reconcile", options);
    },

    /** Historique des rapprochements (manager) */
    getFuelStationStockReconciliations(options = {}) {
      return request("GET", "/fuel-station/stock/reconciliations", options);
    },

    /** Resynchronisation terminal (releves/ventes depuis since_id) */
    getFuelStationSyncOutbox(options = {}) {
      return request("GET", "/fuel-station/sync/outbox", options);
    },

    /** Synchroniser des releves (idempotent par idempotency_key) */
    postFuelStationSyncReadings(options = {}) {
      return request("POST", "/fuel-station/sync/readings", options);
    },
    ...
    postPublicTravelPaymentsInitiate(options = {}) {
      return request("POST", "/public/travel/payments/initiate", options);
    },

    /** Réservation en ligne publique (TRAVEL-1001/#6114) */
    postPublicTravelShopBookings(options = {}) {
    ...
    getPublicTravelTicketsByTicketPdf(options = {}) {
      return request("GET", "/public/travel/tickets/{ticket}/pdf", options);
    ...
    getTravelCancellationPoliciesByTravelCancellationPolicy(options = {}) {
      return request("GET", "/travel/cancellation-policies/{travelCancellationPolicy}", options);
    },
    ...
    postTravelCarrierSyncTrips(options = {}) {
      return request("POST", "/travel/carrier-sync/trips", options);
    },
    ...
    postTravelCommunityAdvertPrices(options = {}) {
      return request("POST", "/travel/community/advert-prices", options);
    },

    /** Types d'annonces (TRAVEL-905/#6108) */
    getTravelCommunityAdvertTypes(options = {}) {
      return request("GET", "/travel/community/advert-types", options);
    },

    /** Création d'un type (TRAVEL-905/#6108, travel.manage) */
    postTravelCommunityAdvertTypes(options = {}) {
      return request("POST", "/travel/community/advert-types", options);
    },

    /** Annonces VISIBLES (payées + validées + non expirées, TRAVEL-907/#6110) */
    getTravelCommunityAdverts(options = {}) {
      return request("GET", "/travel/community/adverts", options);
    },

    /** Soumission d'une annonce (TRAVEL-907/#6110, prix calculé serveur) */
    postTravelCommunityAdverts(options = {}) {
      return request("POST", "/travel/community/adverts", options);
    },

    /** Paiement d'une annonce (TRAVEL-907/#6110, idempotent) */
    postTravelCommunityAdvertsByAdvertPay(options = {}) {
      return request("POST", "/travel/community/adverts/{advert}/pay", options);
    },

    /** Renouvellement payé (TRAVEL-908/#6111, requalifie) */
    postTravelCommunityAdvertsByAdvertRenew(options = {}) {
      return request("POST", "/travel/community/adverts/{advert}/renew", options);
    },

    /** Validation + publication (TRAVEL-907/#6110, travel.manage) */
    postTravelCommunityAdvertsByAdvertValidate(options = {}) {
    ...
    getTravelCommunityArticlesByArticleComments(options = {}) {
      return request("GET", "/travel/community/articles/{article}/comments", options);
    },

    /** Ajout d'un commentaire (TRAVEL-902/#6105) */
    postTravelCommunityArticlesByArticleComments(options = {}) {
      return request("POST", "/travel/community/articles/{article}/comments", options);
    },

    /** Agrégats likes/partages/notes (TRAVEL-903/#6106) */
    getTravelCommunityArticlesByArticleEngagement(options = {}) {
      return request("GET", "/travel/community/articles/{article}/engagement", options);
    },

    /** Like d'un article (TRAVEL-903/#6106, idempotent) */
    postTravelCommunityArticlesByArticleLike(options = {}) {
    ...
    getTravelCommunityCategories(options = {}) {
      return request("GET", "/travel/community/categories", options);
    },

    /** Création d'une catégorie (TRAVEL-901/#6104, travel.manage) */
    postTravelCommunityCategories(options = {}) {
    ...
    getTravelCommunityQuizzes(options = {}) {
      return request("GET", "/travel/community/quizzes", options);
    },

    /** Création d'un quiz (TRAVEL-904/#6107, travel.manage) */
    postTravelCommunityQuizzes(options = {}) {
    ...
    getTravelCommunityTouristSites(options = {}) {
      return request("GET", "/travel/community/tourist-sites", options);
    },
    ...
    getTravelCommunityTouristSitesSearch(options = {}) {
      return request("GET", "/travel/community/tourist-sites/search", options);
    },
    ...
    getTravelCorporateAccounts(options = {}) {
      return request("GET", "/travel/corporate-accounts", options);
    },

    /** Création d'un compte corporate (TRAVEL-803/#6094, travel.manage) */
    postTravelCorporateAccounts(options = {}) {
    ...
    postTravelCorporateQuotes(options = {}) {
      return request("POST", "/travel/corporate-quotes", options);
    },
    ...
    getTravelLoyaltyAccount(options = {}) {
      return request("GET", "/travel/loyalty/account", options);
    },

    /** Journal des points d'un contact (TRAVEL-811/#6101) */
    getTravelLoyaltyEntries(options = {}) {
      return request("GET", "/travel/loyalty/entries", options);
    },
    ...
    postTravelLoyaltyRedeem(options = {}) {
      return request("POST", "/travel/loyalty/redeem", options);
    },

    /** Catalogue des récompenses actives (TRAVEL-811/#6101) */
    getTravelLoyaltyRewards(options = {}) {
      return request("GET", "/travel/loyalty/rewards", options);
    },

    /** Création d'une récompense (TRAVEL-811/#6101, travel.manage) */
    postTravelLoyaltyRewards(options = {}) {
    ...
    postTravelPdvSessionOpen(options = {}) {
      return request("POST", "/travel/pdv/session/open", options);
    },
    ...
    getTravelPublicShopToken(options = {}) {
      return request("GET", "/travel/public-shop-token", options);
    },

    /** Rotation du jeton (TRAVEL-1001/#6114, travel.manage) */
    postTravelPublicShopTokenRotate(options = {}) {
      return request("POST", "/travel/public-shop-token/rotate", options);
    ...
    getTravelShopConnections(options = {}) {
      return request("GET", "/travel/shop/connections", options);
    },

    /** Vente groupée d'une correspondance (TRAVEL-809/#6099) */
    postTravelShopConnectionsBook(options = {}) {
      return request("POST", "/travel/shop/connections/book", options);
    },
    ...
    putRestaurantBranchesByRestaurantBranchCancellationPolicy(options = {}) {
      return request("PUT", "/restaurant/branches/{restaurantBranch}/cancellation-policy", options);
    },
    ...
    getRestaurantDeliveryZones(options = {}) {
      return request("GET", "/restaurant/delivery-zones", options);
    },

    /** Création des zones de livraison */
    postRestaurantDeliveryZones(options = {}) {
      return request("POST", "/restaurant/delivery-zones", options);
    },

    /** Suppression des zones de livraison */
    deleteRestaurantDeliveryZonesByRestaurantDeliveryZone(options = {}) {
      return request("DELETE", "/restaurant/delivery-zones/{restaurantDeliveryZone}", options);
    },

    /** Détail des zones de livraison */
    getRestaurantDeliveryZonesByRestaurantDeliveryZone(options = {}) {
      return request("GET", "/restaurant/delivery-zones/{restaurantDeliveryZone}", options);
    },

    /** Modification des zones de livraison */
    putRestaurantDeliveryZonesByRestaurantDeliveryZone(options = {}) {
      return request("PUT", "/restaurant/delivery-zones/{restaurantDeliveryZone}", options);
    },

    /** Devis de livraison (frais serveur, RESTO-604/#6209) */
    getRestaurantDeliveryZonesByRestaurantDeliveryZoneQuote(options = {}) {
      return request("GET", "/restaurant/delivery-zones/{restaurantDeliveryZone}/quote", options);
    },
    ...
    putRestaurantInventoryCountsByRestaurantInventoryCountItemsByItem(options = {}) {
      return request("PUT", "/restaurant/inventory-counts/{restaurantInventoryCount}/items/{item}", options);
    },
    ...
    getRestaurantInventoryMovementsByRestaurantInventoryMovement(options = {}) {
      return request("GET", "/restaurant/inventory-movements/{restaurantInventoryMovement}", options);
    },
    ...
    getRestaurantPosSessionsByRestaurantPosSessionCogs(options = {}) {
      return request("GET", "/restaurant/pos-sessions/{restaurantPosSession}/cogs", options);
    },
    ...
    getRestaurantReceivingsByRestaurantReceiving(options = {}) {
      return request("GET", "/restaurant/receivings/{restaurantReceiving}", options);
    },
    ...
    postRestaurantReservationsByRestaurantReservationDeposit(options = {}) {
      return request("POST", "/restaurant/reservations/{restaurantReservation}/deposit", options);
    },
    ...
    postRestaurantStockLevels(options = {}) {
      return request("POST", "/restaurant/stock-levels", options);
    },

    /** Suppression des niveaux de stock */
    deleteRestaurantStockLevelsByRestaurantStockLevel(options = {}) {
      return request("DELETE", "/restaurant/stock-levels/{restaurantStockLevel}", options);
    },

    /** Détail des niveaux de stock */
    getRestaurantStockLevelsByRestaurantStockLevel(options = {}) {
      return request("GET", "/restaurant/stock-levels/{restaurantStockLevel}", options);
    },
    ...
    getRestaurantStockAlerts(options = {}) {
      return request("GET", "/restaurant/stock/alerts", options);
    },
