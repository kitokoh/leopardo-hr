...
export function createLeopardoClient({ baseUrl, token, fetchImpl = globalThis.fetch } = {}) {
  ...
  return {
    ...
    postEmployeeJoinRequestsByJoinRequestApprove(options = {}) {
      return request("POST", "/employee-join-requests/{joinRequest}/approve", options);
    },
    ...
    getUserCompaniesDirectory(options = {}) {
      return request("GET", "/user/companies/directory", options);
    },
    ...
    getUserEmployeeJoinRequests(options = {}) {
      return request("GET", "/user/employee-join-requests", options);
    },

    /** Demande à rejoindre une entreprise */
    postUserEmployeeJoinRequests(options = {}) {
      return request("POST", "/user/employee-join-requests", options);
    },
    ...
    getUserJobApplicationNotifications(options = {}) {
      return request("GET", "/user/job-application-notifications", options);
    },

    /** Marque comme lues les notifications de candidature */
    patchUserJobApplicationNotificationsRead(options = {}) {
      return request("PATCH", "/user/job-application-notifications/read", options);
    },

    /** Liste l’historique des candidatures de l’utilisateur */
    getUserJobApplications(options = {}) {
      return request("GET", "/user/job-applications", options);
    },

    /** Dépose une candidature authentifiée */
    postUserJobApplicationsByCompanySlugByJobPosting(options = {}) {
      return request("POST", "/user/job-applications/{companySlug}/{jobPosting}", options);
    },

    /** Retourne les offres recommandées au candidat */
    getUserJobRecommendations(options = {}) {
      return request("GET", "/user/job-recommendations", options);
    },

    /** Met à jour les préférences de recherche d’emploi */
    putUserJobSearchProfile(options = {}) {
      return request("PUT", "/user/job-search-profile", options);
    },

    /** Téléverse une version privée du CV */
    postUserJobSearchProfileResume(options = {}) {
      return request("POST", "/user/job-search-profile/resume", options);
    },
    ...
    getUserPersonalOnboarding(options = {}) {
      return request("GET", "/user/personal-onboarding", options);
    },

    /** Enregistre les statuts personnels cumulables */
    putUserPersonalOnboarding(options = {}) {
      return request("PUT", "/user/personal-onboarding", options);
    },
