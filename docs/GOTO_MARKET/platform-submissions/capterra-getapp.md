...
- [x] Bonus, Loan & Advance Management
- [x] Document Management
- [x] Employee Database
- [x] Leave Management System
- [x] Multi-Country Payroll
- [x] Reporting/Analytics
- [x] Self Service Portal
- [x] Mobile Access (Android & iOS)

**Pricing Model**  
- **Free Version:** Yes (Open Source Core)
- **Free Trial:** Yes (SaaS offering)
- **Subscription:** Starting from [TBD] per employee/month.

## Conseils de publication

Capterra et GetApp appartiennent au réseau Gartner. Une seule soumission permet souvent d'être listé sur les deux. Mettez l'accent sur la facilité d'utilisation mobile, car c'est un critère de recherche majeur sur GetApp. Pour Capterra, assurez-vous que la liste des fonctionnalités est exhaustive pour apparaître dans les filtres de recherche.
