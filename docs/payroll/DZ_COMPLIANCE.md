...
| Préavis — durées légales | ✅ implémenté (#1819/#1943) : **1 mois si ancienneté < 10 ans, 2 mois si ≥ 10 ans** en **jours ouvrés (22/44)** — indemnité = base × j_ouvrés/22 = 1 ou 2 salaires mensuels exacts (l'ancienne unité calendaire 30/60 sur-payait de 1,36×) ; **conditionné au licenciement CDI avec dispense** (pas de préavis CDD à terme/démission/faute lourde, paramètre `departure_reason`) | loi 90-11 art. 73-4/98 (2 h/j de recherche d'emploi pendant le délai-congé) ; la **durée** est renvoyée aux conventions collectives/règlement intérieur — valeur retenue = usage dominant, confidenceLevel reste `pilot` | Validation expert comptable DZ avant passage `production` |
...
| Assurance chômage | ✅ **pas de ligne séparée — CNAC inclus dans CNAS (#1943)** | LF 2022 art. 189 ; décrets exécutifs n° 22-70 (10/02/2022) et n° 26-87 (21/01/2026) ; CNAC (décret législatif n° 94-11, art. 94-188) | Le régime contributif CNAC couvre les salariés du privé licenciés pour motif économique (1 % patronal + 0,5 % salarié) **déjà inclus dans les agrégats CNAS 9 %/26 %** — pas de codes AC_DZ_EMP/AC_DZ_PAT (double cotisation interdite) ; l'allocation chômage des primo-demandeurs (ANEM, 13 000 DZD/mois) est financée par l'État |
