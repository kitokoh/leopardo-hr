...
## Liens
- Plan 60 jours : `docs/GESTION_PROJET/PLAN_60_JOURS.md` (plan J1-J60, statuts figés au 2026-08-20) — voir aussi `docs/GOUVERNANCE/FREEZE_SCOPE_60J.md` (gate de scope)
