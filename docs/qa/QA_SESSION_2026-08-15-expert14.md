# QA Session — Expert 14 (2026-08-15) — version consolidée

> Fusion de deux rapports complémentaires sur la même session (round 1 mergé sur main,
> round 2 via PR #4279). Les deux rapports sont conservés intégralement ci-dessous.
