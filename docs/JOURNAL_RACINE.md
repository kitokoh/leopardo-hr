...
| 2026-07-29 | KiloClaw | Audit doc P2 : index central docs/README.md complete | `docs/README.md`, `CHANGELOG.md` | Audit lecture-seule (token GitHub temporaire) : 16 sous-dossiers de `docs/` (GESTION_PROJET, audits, validation, specifications, vision, CONTEXT, GUIDES, GTM, STRATEGIE_COMMERCIALE, commercial, admin, ai, api-mock-data, edge-sync, kiosk, external-audits, assets) etaient absents de l'index central. Ajout de 3 sections ("Produit & Strategie" etendue, nouvelle "Pilotage projet, audits & validation", nouvelle "Domaines techniques additionnels") couvrant les 16 dossiers manquants |
