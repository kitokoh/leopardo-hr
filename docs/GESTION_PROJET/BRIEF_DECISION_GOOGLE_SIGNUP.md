...
- QA : `docs/archive/qa/QA_RAPPORT_2026-08-17.md` (F1 création employé 500 — corrigé ; F2 trial pending — #4948).
...
- Plan : `docs/GESTION_PROJET/PLAN_60_JOURS.md` (KPI 1 conversion ≥ 30 %, KPI 2 trial < 2 min).
