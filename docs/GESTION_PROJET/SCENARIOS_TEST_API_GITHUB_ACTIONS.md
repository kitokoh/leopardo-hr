...
Note 2026-08-14 (#1827) : Sénégal pilot — CFCE + TRIMF + IPRES cadres T2. Aucun endpoint HTTP ajouté/modifié — règles pays `SenegalPayrollRules`. Scénarios : TRIMF par tranche (6 bruts), IPRES T1 plafonné 432k + T2 sur tranche (1M → 37 824 salarié / 126 736 patronal), CSS famille/AT + CFCE non plafonnés, abattement 30 %, préavis par ancienneté. Couverture : `GoldenSnPilotTest` + `AbstractCountryRulesCapTest`.
