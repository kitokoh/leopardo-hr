...
| PA2-AUTO-008 | P2 | ~~Regles~~ Fait: section "Regles agents juniors" dans `AGENTS.md` | `AGENTS.md`, docs | FAIT: comment choisir un ticket sans dupliquer, rappel condense du protocole de claim (`01_MODE_EXECUTION_MULTI_AGENT.md`), quand demander une review humaine explicite |
