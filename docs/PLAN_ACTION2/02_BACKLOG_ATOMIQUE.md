...
| PA2-MKT-010 | P0 | Corriger les avatars temoignages casses | `front/web/src/modules/vitrine/data/testimonials.ts`, `front/web/public/avatars` | plus aucune reference a un fichier avatar inexistant; fichiers ajoutes, entrees repointees, ou fallback initiales/silhouette sans jamais afficher une icone brisee |
| PA2-MKT-011 | P0 | Trancher et documenter le statut des marques "Ils nous font confiance" | `front/web/src/modules/vitrine/components/sections/TrustedBrands.tsx` | decision ecrite: liste remplacee par des clients/pilotes reels avec autorisation, ou requalifiee visuellement en "marches vises"/"secteurs adresses" sans laisser croire a une relation client existante |
| PA2-MKT-012 | P1 | Nettoyer les exports vitrine legacy dupliques | `front/web/src/modules/vitrine/components/index.ts`, pages `(landing)` | audit d'usage reel des exports `Legacy*`; suppression si non references, ou justification ecrite si conserves |
...
## Extension v1.5 - Plan d'action en vigueur 2026-07-20 (voir `12_PLAN_ACTION_EN_VIGUEUR_2026-07-20.md`)
