...
| 2-3 | **Recherche dans user_lookups (public schema)** | Le contrôleur interroge la table publique `user_lookups` pour retrouver le schéma tenant associé à l'email. Si l'utilisateur n'existe pas, une erreur 401 est renvoyée immédiatement. |
