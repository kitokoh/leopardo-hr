...
final cabinetFoldersProvider = FutureProvider.family<
  List<CabinetFolder>,
  int?
>((ref, parentId) async {
...
final cabinetDocumentsProvider = FutureProvider.family<
  List<CabinetDocument>,
  int?
>((ref, folderId) async {
  final repo = ref.watch(cabinetRepositoryProvider);
...
final cabinetStatsProvider = FutureProvider<Map<String, dynamic>>((
  ref,
) async {
  final repo = ref.watch(cabinetRepositoryProvider);
