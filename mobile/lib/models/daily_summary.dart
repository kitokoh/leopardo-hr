class DailySummary {
  ...
  factory DailySummary.fromJson(Map<String, dynamic> json) {
    return DailySummary(
      hoursWorked: json['hours_worked'] != null ? (json['hours_worked'] as num).toDouble() : 0.0,
      overtimeHours: json['overtime_hours'] != null ? (json['overtime_hours'] as num).toDouble() : 0.0,
