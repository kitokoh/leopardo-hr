...
Map<String, dynamic> _$ListSchemaToJson(
  ListSchema instance,
) => <String, dynamic>{
  ...
  if (instance.actions?.map((e) => e.toJson()).toList() case final value?)
    'actions': value,
  if (instance.searchPlaceholder case final value?) 'search_placeholder': value,
...
ListColumn _$ListColumnFromJson(Map<String, dynamic> json) => ListColumn(
  ...
  alignment:
      $enumDecodeNullable(_$ListColumnAlignmentEnumMap, json['alignment']) ??
...
Map<String, dynamic> _$ListPaginationToJson(
  ListPagination instance,
) => <String, dynamic>{
  'page_size': instance.pageSize,
  'enabled': instance.enabled,
  if (instance.pageSizeOptions case final value?) 'page_size_options': value,
};
...
ListSorting _$ListSortingFromJson(Map<String, dynamic> json) => ListSorting(
  ...
  defaultDirection:
      $enumDecodeNullable(
        _$ListSortDirectionEnumMap,
        json['default_direction'],
      ) ??
      ListSortDirection.asc,
  multiColumn: json['multi_column'] as bool? ?? false,
);

Map<String, dynamic> _$ListSortingToJson(
  ListSorting instance,
) => <String, dynamic>{
  if (instance.defaultColumn case final value?) 'default_column': value,
  'default_direction': _$ListSortDirectionEnumMap[instance.defaultDirection]!,
