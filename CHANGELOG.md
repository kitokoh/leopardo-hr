...
### Fixed
- **docs(oss): santé open-source (#1730) + workflows internes marqués (#1731).** Création de `SUPPORT.md` (canaux + SLA), lien depuis `CONTRIBUTING.md`, bannière « INTERNAL GOVERNANCE » sur les 4 workflows PLAN_ACTION2 (non bloquants pour les contributeurs externes).
