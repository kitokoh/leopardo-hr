...
const stats = [
  ...
  { value: 50, suffix: 'K+', label: 'Employes geres', icon: Users },
      ...
      <motion.div style={{ y, opacity, scale }} className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-32 pb-24">
        <div className="text-center max-w-5xl mx-auto">
          ...
          >
            ...
            <span>Leo IA 2.0 disponible</span>
            <span className="px-2 py-0.5 bg-emerald-500 text-white text-[10px] font-black uppercase tracking-wider rounded-full">New</span>
          </motion.div>
          ...
          >
            La plateforme tout-en-un pour moderniser votre gestion du personnel.{' '}
            <span className="text-slate-900 dark:text-white font-medium">Pointage, paie, absences</span>{' '}
            et intelligence artificielle integree.
          </motion.p>
