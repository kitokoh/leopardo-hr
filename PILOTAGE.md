...
# PROGRAM_VERSION = 4.16.14 | 2026-05-13
...
```
VERSION  = 4.1.87   → Version globale du projet/pilotage (ce fichier fait foi)
...
Code           : ✅ `main` inclut le MVP livré + i18n + hardening P0/P1/P2 + salary advances + payroll RH (voir CHANGELOG.md jusqu'à 4.1.100)
...
Prochaine action : Consolider les parcours pilotes, fermer les écarts documentaires restants et préparer les prochains modules sans dérive de scope
...
### âŒ EXCLU DU MVP (tout ça existe dans les specs, sera fait plus tard)
...
| S4-6 | **Plan d'Action d'Amélioration (Phase 1)** | IA | Sécurité P0 : Chiffrement, CORS, Lockout | ✅ |
