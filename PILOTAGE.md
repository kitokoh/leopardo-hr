...
Code           : âœ… `main` inclut le MVP livrÃ© + i18n + hardening P0/P1/P2 + salary advances + payroll RH (voir CHANGELOG.md jusqu'Ã  4.1.87)
...
| 8 | DÃ©cision MVP | `docs/GESTION_PROJET/GO_NO_GO_MVP.md` | DÃ©cision officielle GO MVP et pÃ©rimÃ¨tre validÃ© |
