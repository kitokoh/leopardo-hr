...
# PROGRAM_VERSION = 4.1.96 | 2026-05-07
...
```
VERSION  = 4.1.96   → Version globale du projet/pilotage (ce fichier fait foi)
...
Code           : ✅ `main` inclut le MVP livré + i18n + hardening P0/P1/P2 + salary advances + payroll RH (voir CHANGELOG.md jusqu'à 4.1.96)
