...
> **Document canonique** (fusion 2026-09-20, issue #7843) : ce fichier
> `.github/BRANCH_PROTECTION_REQUIRED.md` est désormais la source de vérité
> documentaire, synchronisée avec le référentiel machine de la garde #2011
> (`dev-hub/tools/branch-protection-canonical.json`). Le fichier racine
> `BRANCH_PROTECTION_REQUIRED.md` n'est qu'un renvoi vers celui-ci.
>
