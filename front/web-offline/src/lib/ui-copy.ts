 ...
 * non traduites : "Node ID", "Leopardo Edge", "Statut", "https://leopardo.local".
 */
...
export type UiCopy = {
  ...
  /** #7653 : affiché quand l'API est jointe en same-origin (proxy TLS). */
  sameOrigin: string;
};
...
export const uiCopy: Record<UiLocale, UiCopy> = {
  fr: {
    ...
    connecting: 'Connexion à https://leopardo.local…',
  ...
  en: {
    ...
    connecting: 'Connecting to https://leopardo.local…',
  ...
  tr: {
    ...
    connecting: 'https://leopardo.local bağlanılıyor…',
  ...
  ar: {
    ...
    connecting: 'جارٍ الاتصال بـ https://leopardo.local…',
