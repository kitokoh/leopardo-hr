    ...
    <Teleport to="body">
      ...
      >
        <div class="max-h-[92vh] w-full max-w-3xl overflow-y-auto rounded-3xl border border-white/10 glass-card shadow-2xl dark:border-slate-800 dark:bg-slate-950 sm:p-0">
          <div class="sticky top-0 z-20 flex items-center justify-between border-b border-slate-100 bg-white/90 dark:bg-slate-900/90 px-6 py-5 dark:border-slate-800 dark:bg-slate-950/90 backdrop-blur-md">
            <div>
