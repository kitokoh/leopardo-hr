      ...
      <section class="card xl:col-span-2">
        ...
        <div v-else class="grid grid-cols-1 gap-6 p-6 lg:grid-cols-2">
          <article
            v-for="plan in plans"
            :key="plan.id"
            class="group relative flex flex-col rounded-3xl border border-slate-200/60 backdrop-blur-md p-6 shadow-sm transition-all hover:shadow-glass-lg hover:-translate-y-1 dark:border-slate-800 dark:bg-slate-900/40 overflow-hidden"
          >
