      ...
      <main class="sm:flex">
        ...
        <div class="sm:ml-6">
          ...
          <div class="mt-10 flex space-x-3 sm:border-l sm:border-transparent sm:pl-6">
            ...
            <button
              @click="goBack"
              class="inline-flex items-center rounded-md px-3 py-2 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 glass-bg-hover"
            >
              Page précédente
            </button>
          </div>
        ...
        <div class="mt-4 grid grid-cols-1 gap-4 sm:grid-cols-2">
          ...
          >
            <div>
              <span class="absolute inset-0" aria-hidden="true"></span>
              <div class="flex items-center">
                <ChatBubbleLeftRightIcon class="h-6 w-6 text-gray-400 group-hover:text-gray-500" />
                <div class="ml-3">
                  <p class="text-sm font-medium text-gray-900">Support</p>
                  <p class="text-sm text-gray-500">Tickets de support</p>
                </div>
              </div>
            </div>
          </router-link>
