  ...
  // settings posé nu sous « Modules clients ».
  {
    ...
    children: [
      ...
      },
      {
        ...
        menuTitleKey: 'navigation.accountingChartMenu',
        icon: ListBulletIcon,
        permission: 'companies.view',
        group: 'modules-clients',
      },
      {
        ...
        menuTitleKey: 'navigation.accountingLedgerMenu',
        icon: BookOpenIcon,
        permission: 'companies.view',
        group: 'modules-clients',
      },
      {
        ...
        menuTitleKey: 'navigation.accountingLetteringMenu',
        icon: LinkIcon,
        permission: 'companies.view',
        group: 'modules-clients',
      },
      {
        ...
        menuTitleKey: 'navigation.accountingFiscalYearsMenu',
      ...
      },
      {
        ...
        menuTitleKey: 'navigation.accountingBankMenu',
      ...
      },
      {
        ...
        menuTitleKey: 'navigation.accountingStatementsMenu',
