...
class TranslationCatalogCache {
  ...
  Map<String, dynamic>? readCatalog(String locale) {
    final value = _box.get('$_catalogPrefix$locale');
  ...
  String? readChecksum(String locale) {
    final value = _box.get('$_checksumPrefix$locale');

    return value is String && value.isNotEmpty ? value : null;
  }

  String? readVersion(String locale) {
    final value = _box.get('$_versionPrefix$locale');

    return value is String && value.isNotEmpty ? value : null;
  }

  String? readUpdatedAt(String locale) {
    final value = _box.get('$_updatedAtPrefix$locale');
  ...
  Future<void> save({
    ...
    await _box.put('$_catalogPrefix$locale', catalog);
    await _box.put('$_checksumPrefix$locale', checksum);
    await _box.put('$_versionPrefix$locale', version);
    await _box.put('$_updatedAtPrefix$locale', updatedAt);
  }
}
