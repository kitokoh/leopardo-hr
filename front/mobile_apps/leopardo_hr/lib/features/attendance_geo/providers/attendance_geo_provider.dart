...
import 'package:leopardo_hr/features/attendance_geo/data/attendance_geo_repository.dart';
import 'package:leopardo_core/features/attendance_geo/data/models/geo_attendance_session.dart';

final hrAttendanceGeoRepositoryProvider =
    Provider<HrAttendanceGeoRepository>((ref) {
  return HrAttendanceGeoRepository(ref.watch(apiClientProvider));
});
...
final pendingGeoSessionsProvider =
  ...
  return ref.watch(hrAttendanceGeoRepositoryProvider).getPendingSessions();
});

/// Stats du dashboard Smart Attendance.
final smartAttendanceDashboardProvider =
    FutureProvider.autoDispose<Map<String, dynamic>>((ref) async {
  return ref.watch(hrAttendanceGeoRepositoryProvider).getDashboardStats();
});
