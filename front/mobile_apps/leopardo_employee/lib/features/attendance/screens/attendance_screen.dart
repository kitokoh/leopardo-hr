          ...
          children: [
            ...
            ...choices.map(
              (choice) => ListTile(
                ...
                title: Text(choice.title, style: const TextStyle(color: _text)),
                subtitle: Text(
                  choice.subtitle,
      ...
      children: [
        ...
        PopupMenuButton<String>(
          ...
          itemBuilder: (_) => const [
            ...
            PopupMenuItem(
              value: 'preferences',
              child: _MenuItem(icon: Icons.tune_outlined, label: 'Preferences'),
            ),
            PopupMenuItem(
              value: 'settings',
              child: _MenuItem(
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            children: [
              Expanded(
                child: _TimeChip(label: 'Arrivee', value: checkIn),
              ),
              const SizedBox(width: 10),
              Expanded(
                child: _TimeChip(label: 'Depart', value: checkOut),
              ),
            ],
          ),
          ...
          child: Consumer(
            builder: (context, ref, _) {
              final anomaliesAsync = ref.watch(
                monthlyAnomaliesProvider(day.date),
              );
  ...
  static Color _workTypeColor(String raw) {
    switch (raw) {
      case 'overtime':
        return AppColors.warning;
      case 'break':
        return AppColors.mobileDarkDisabled;
      case 'mission':
      case 'travel':
        return AppColors.mobileAccentSkyBlue;
      default:
        return AppColors.rh;
    }
  }
    ...
    return Column(
      children: [
        ...
        Text(
          ...
          style: const TextStyle(
            fontSize: 10,
            color: AppColors.mobileDarkDisabled,
          ),
        ),
      ],
    );
