...
/// État d'authentification (pattern leopardo_travel_agent, fichier préfixé
/// « cameras_ » pour le garde anti-duplication core<->apps #7652).
class AuthState {
...
class AuthNotifier extends StateNotifier<AuthState> {
  ...
  final CamerasAuthRepository _repository;
  ...
  Future<void> logout() async {
    ...
    // `copyWith(employee: null)` conserverait l'employé (opérateur ??) :
    // on repart d'un état vierge pour que le redirect() renvoie sur /login.
