...
/// Écran de connexion (email + mot de passe, pattern leopardo_travel_agent,
/// fichier préfixé « cameras_ » pour le garde anti-duplication #7652).
///
/// `/cameras/*` exige `auth:sanctum` + `module.cameras` + `api.manager` :
...
class CamerasLoginScreen extends ConsumerStatefulWidget {
  const CamerasLoginScreen({super.key});

  @override
  ConsumerState<CamerasLoginScreen> createState() =>
      _CamerasLoginScreenState();
}

class _CamerasLoginScreenState extends ConsumerState<CamerasLoginScreen> {
                  ...
                  Container(
                    ...
                    decoration: const BoxDecoration(
                      ...
                      gradient: LinearGradient(
                        colors: [AppColors.security, AppColors.securityDark],
                      ),
                    ),
                    child: const Icon(
