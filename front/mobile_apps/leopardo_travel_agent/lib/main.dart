...
import 'features/travel/screens/agent_home_screen.dart';
import 'features/travel/screens/booking_flow_screen.dart';
import 'features/travel/screens/bookings_screen.dart';
import 'features/travel/screens/manifest_screen.dart';
import 'features/travel/screens/pdv_screen.dart';
import 'features/travel/screens/trip_detail_screen.dart';
import 'features/travel/screens/trip_search_screen.dart';
...
// ─── Router ───────────────────────────────────────────────────────────────────
//
// `/travel/*` est protégé par auth:sanctum + permissions `travel.*` — le
// redirect() exige une session valide (pattern ValueNotifier +
// refreshListenable, cf. leopardo_accounting).
...
class LeopardoTravelAgentApp extends ConsumerWidget {
  const LeopardoTravelAgentApp({super.key});
