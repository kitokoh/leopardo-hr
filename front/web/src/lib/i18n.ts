...
const copy: Record<AppLocale, CopyTree> = {
  fr: {
    ...
    absences: {
      ...
      rejectReasonRequired: 'Le motif est obligatoire pour refuser.',
      dateRequired: 'Renseignez les dates de début et de fin.',
      ...
      attachProof: 'Joindre un justificatif (optionnel)',
      ...
      daysAvailable: ' j disponibles',
      daysShort: ' j',
      noTypeAvailable: 'Aucun type d\'absence disponible pour ce compte. Contactez le RH pour configurer les soldes.',
      balancesLoading: 'Chargement des soldes',
    },
    leaveBalances: {
      ...
      loadError: 'Impossible de charger vos soldes.',
    },
    payrollPage: {
      title: 'Paie',
  ...
  ar: {
    ...
    absences: {
      ...
      rejectReasonRequired: 'السبب إلزامي للرفض.',
      ...
      attachProof: 'إرفاق مستند (اختياري)',
      proofAttached: 'تم إرفاق المستند',
      ...
      daysShort: ' ي',
      noTypeAvailable: 'لا يوجد نوع غياب متاح لهذا الحساب. اتصل بالموارد البشرية لتهيئة الأرصدة.',
      balancesLoading: 'جارٍ تحميل الأرصدة',
    },
    leaveBalances: {
  ...
  tr: {
    ...
    absences: {
      ...
      rejectReasonRequired: 'Reddetmek için neden zorunludur.',
      dateRequired: 'Başlangıç ve bitiş tarihlerini girin.',
      ...
      attachProof: 'Belge ekle (isteğe bağlı)',
      proofAttached: 'Belge eklendi',
      ...
      daysShort: ' g',
      noTypeAvailable: 'Bu hesap için izin türü yok. Bakiyeleri yapılandırmak için İK ile iletişime geçin.',
      balancesLoading: 'Bakiyeler yükleniyor',
    },
    leaveBalances: {
      ...
      loading: 'Bakiyeler yükleniyor…',
      loadError: 'Bakiyeleriniz yüklenemedi.',
    },
    payrollPage: {
      title: 'Bordro',
  ...
  en: {
    ...
    absences: {
      ...
      dateRequired: 'Provide the start and end dates.',
      ...
      attachProof: 'Attach a supporting document (optional)',
      proofAttached: 'Supporting document attached',
      submitToHr: 'Submit to HR',
      submitting: 'Sending…',
      submittedSnack: 'Absence request sent to HR.',
      submitError: 'Unable to send the request.',
      daysAvailable: ' day(s) available',
      daysShort: ' d',
      noTypeAvailable: 'No absence type available for this account. Contact HR to configure balances.',
      balancesLoading: 'Loading balances',
    },
    leaveBalances: {
      title: 'Leave balances',
      subtitle: 'Your remaining days per type',
      available: 'Available',
      used: 'Used',
      pending: 'Pending',
