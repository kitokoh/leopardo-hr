        ...
        <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            {filtered.map((integration, index) => (
              ...
              >
                <div className="flex items-start justify-between mb-4">
                  <div className="w-12 h-12 rounded-xl bg-emerald-50 dark:bg-emerald-900/20 flex items-center justify-center text-emerald-700 dark:text-emerald-400">
                    {integration.icon}
                  </div>
          ...
          >
            <div className="inline-flex items-center gap-2 bg-slate-100 dark:bg-slate-800 rounded-full px-6 py-3 text-slate-600 dark:text-slate-400">
              ...
              <a href={`${resolveBackendBaseUrl().replace(/\/api\/v1$/, '')}/api-explorer`} target="_blank" rel="noopener noreferrer" className="text-sm font-semibold text-emerald-700 dark:text-emerald-400 hover:underline inline-flex items-center gap-1">
