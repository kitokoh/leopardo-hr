...
const copy: Record<Lang, LangCopy> = {
  fr: {
    ...
    downloadSub: "Accès anticipé : les applications sont distribuées à la liste de testeurs, la publication sur les stores publics arrive ensuite.",
    android: 'Google Play',
    ios: 'App Store',
  ...
  en: {
    ...
    downloadSub: 'Early access: apps are distributed to the tester list; public store release comes next.',
    android: 'Google Play',
    ios: 'App Store',
    soon: 'Coming soon',
    beta: 'Beta',
  ...
  tr: {
    ...
    downloadSub: 'Erken erişim: uygulamalar test listesine dağıtılır; mağaza yayını sonraki adımdır.',
    android: 'Google Play',
    ios: 'App Store',
    soon: 'Çok yakında',
    beta: 'Beta',
  ...
  ar: {
    ...
    downloadSub: 'وصول مبكر: تُوزَّع التطبيقات على قائمة المختبِرين، ويأتي النشر العام لاحقًا.',
    android: 'Google Play',
    ios: 'App Store',
    soon: 'قريباً',
    beta: 'نسخة تجريبية',
