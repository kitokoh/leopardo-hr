...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const seo = getPageMetadata('guideRhStartup', lang);
...
export default async function GuidesRHStartupLayout({
  children,
}: {
  ...
  const guide = getPageMetadata('guideRhStartup', lang);
    ...
    <>
      <BreadcrumbJsonLd
        items={[
          ...
          { name: guide.title, url: localizedUrl('/guides/rh-startup', lang) },
        ]}
      />
      {children}
    </>
