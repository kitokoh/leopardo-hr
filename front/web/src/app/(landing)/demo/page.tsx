...
const demoCopy: Record<AppLocale, DemoCopy> = {
  ...
  ar: {
    hero: {
      headline: 'Ø§Ø·Ù„Ø¨ Ø¹Ø±Ø¶Ø§ ØªÙˆØ¶ÙŠØ­ÙŠØ§ Ù„Ù…Ù†ØµØ© Leopardo RH',
      subheadline: 'Ø´Ø§Ù‡Ø¯ ÙƒÙŠÙ ØªØ¹Ù…Ù„ Ø§Ù„Ù…ÙˆØ§Ø±Ø¯ Ø§Ù„Ø¨Ø´Ø±ÙŠØ© ÙˆØ§Ù„Ø±ÙˆØ§ØªØ¨ ÙˆØ§Ù„Ø­Ø¶ÙˆØ± ÙˆØ§Ù„ØªØ·Ø¨ÙŠÙ‚ ÙˆØ§Ù„Ø¥Ø¯Ø§Ø±Ø© ÙÙŠ Ù…Ù†ØµØ© ÙˆØ§Ø­Ø¯Ø©.',
      cta: 'Ø§Ù…Ù„Ø£ Ø§Ù„Ù†Ù…ÙˆØ°Ø¬',
      badge: 'Ø¹Ø±Ø¶ Ù…Ø¬Ø§Ù†ÙŠ',
    },
    benefitsTitle: 'Ù…Ø§ Ø§Ù„Ø°ÙŠ Ø³ØªÙƒØªØ´ÙÙ‡',
    benefits: [
      { title: 'Ø¥Ø¯Ø§Ø±Ø© ÙƒØ§Ù…Ù„Ø© Ù„Ù„Ù…ÙˆØ¸ÙÙŠÙ†', desc: 'Ø§Ù„Ø­Ø¶ÙˆØ±ØŒ Ø§Ù„Ø¥Ø¬Ø§Ø²Ø§ØªØŒ Ø§Ù„Ø¹Ù‚ÙˆØ¯ ÙˆØ§Ù„Ù…Ø³ØªÙ†Ø¯Ø§Øª ÙÙŠ ØªØ¬Ø±Ø¨Ø© Ù…ÙˆØ­Ø¯Ø©.' },
      { title: 'Ø±ÙˆØ§ØªØ¨ Ø¢Ù„ÙŠØ© Ù…ØªØ¹Ø¯Ø¯Ø© Ø§Ù„Ø¯ÙˆÙ„', desc: 'Ù†Ù…Ø§Ø°Ø¬ DZ Ùˆ MA Ùˆ TN Ùˆ FR Ùˆ TR Ù…Ø¹ Ø§Ù„Ø§Ø´ØªØ±Ø§ÙƒØ§Øª ÙˆØ§Ù„Ø¶Ø±ÙŠØ¨Ø© ÙˆÙ‚Ø³Ø§Ø¦Ù… PDF.' },
      { title: 'Ù„ÙˆØ­Ø© Ø¨ÙŠØ§Ù†Ø§Øª ÙÙˆØ±ÙŠØ©', desc: 'Ù…Ø¤Ø´Ø±Ø§Øª ÙˆØªÙ†Ø¨ÙŠÙ‡Ø§Øª ÙˆØ¨ÙŠØ§Ù†Ø§Øª ØªØ´ØºÙŠÙ„ÙŠØ© Ù„ÙØ±Ù‚ Ø§Ù„Ù…ÙˆØ§Ø±Ø¯ Ø§Ù„Ø¨Ø´Ø±ÙŠØ© ÙˆØ§Ù„Ù…Ø¯ÙŠØ±ÙŠÙ†.' },
      { title: 'Ø£Ù…Ø§Ù† Ù…Ø¤Ø³Ø³ÙŠ', desc: 'Ø¹Ø²Ù„ Ø§Ù„Ø´Ø±ÙƒØ§ØªØŒ Ø§Ù„Ø£Ø¯ÙˆØ§Ø±ØŒ Ø³Ø¬Ù„ Ø§Ù„ØªØ¯Ù‚ÙŠÙ‚ØŒ Ø§Ù„ØªØ´ÙÙŠØ± ÙˆÙ…Ø³Ø§Ø±Ø§Øª Ø¹Ù…Ù„ Ù…Ø¶Ø¨ÙˆØ·Ø©.' },
    ],
    formTitle: 'Ø®Ø·Ø· Ø§Ù„Ø¹Ø±Ø¶ Ø§Ù„ØªÙˆØ¶ÙŠØ­ÙŠ',
    successTitle: 'ØªÙ… Ø¥Ø±Ø³Ø§Ù„ Ø§Ù„Ø·Ù„Ø¨',
    successMessage: 'Ø³ÙŠØªÙˆØ§ØµÙ„ Ù…Ø¹Ùƒ ÙØ±ÙŠÙ‚Ù†Ø§ Ø®Ù„Ø§Ù„ 24 Ø³Ø§Ø¹Ø© Ù„ØªÙ†Ø¸ÙŠÙ… Ø¹Ø±Ø¶ Ù…Ù†Ø§Ø³Ø¨ Ù„Ø³ÙŠØ§Ù‚Ùƒ.',
    submitError: 'ØªØ¹Ø°Ø± Ø¥Ø±Ø³Ø§Ù„ Ø§Ù„Ø·Ù„Ø¨',
    fields: {
      name: 'Ø§Ù„Ø§Ø³Ù… Ø§Ù„ÙƒØ§Ù…Ù„ *',
      email: 'Ø§Ù„Ø¨Ø±ÙŠØ¯ Ø§Ù„Ù…Ù‡Ù†ÙŠ *',
      company: 'Ø§Ù„Ø´Ø±ÙƒØ© *',
      phone: 'Ø§Ù„Ù‡Ø§ØªÙ',
      employees: 'Ø¹Ø¯Ø¯ Ø§Ù„Ù…ÙˆØ¸ÙÙŠÙ†',
      employeesPlaceholder: 'Ø§Ø®ØªØ±',
      employeeSuffix: 'Ù…ÙˆØ¸Ù',
      preferredDate: 'Ø§Ù„ØªØ§Ø±ÙŠØ® Ø§Ù„Ù…ÙØ¶Ù„',
      message: 'Ø±Ø³Ø§Ù„Ø© (Ø§Ø®ØªÙŠØ§Ø±ÙŠ)',
      messagePlaceholder: 'ØµÙ Ø§Ø­ØªÙŠØ§Ø¬Ø§ØªÙƒ...',
    },
    placeholders: {
      name: 'Ø§Ø³Ù…Ùƒ',
      email: 'you@company.com',
      company: 'Ø§Ø³Ù… Ø´Ø±ÙƒØªÙƒ',
      phone: '+213 5XX XXX XXX',
    },
    submit: 'Ø·Ù„Ø¨ Ø¹Ø±Ø¶ ØªÙˆØ¶ÙŠØ­ÙŠ',
