...
> = {
  fr: {
    ...
    shortcuts: [
      { name: 'Essai gratuit', short_name: 'Essai', description: 'Commencer un essai gratuit de 30 jours', url: '/signup?source=pwa_shortcut' },
  ...
  en: {
    ...
    shortcuts: [
      { name: 'Free trial', short_name: 'Trial', description: 'Start a free 30-day trial', url: '/signup?source=pwa_shortcut' },
  ...
  tr: {
    ...
    shortcuts: [
      { name: 'Ücretsiz deneme', short_name: 'Deneme', description: '30 günlük ücretsiz denemeyi başlatın', url: '/signup?source=pwa_shortcut' },
  ...
  ar: {
    ...
    shortcuts: [
      { name: 'تجربة مجانية', short_name: 'تجربة', description: 'ابدأ تجربة مجانية لمدة 30 يومًا', url: '/signup?source=pwa_shortcut' },
