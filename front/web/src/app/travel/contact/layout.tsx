...
/**
 * Métadonnées du formulaire de contact voyageurs public (TRAVEL-913).
 *
 ...
 * n'est atteignable qu'avec un lien signé et expirable (`signature` + `expires`) émis par l'agence — elle n'a aucun sens pour un robot
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    title: t(locale, 'travel.travel.bookings.title'),
    alternates: { canonical: `${SITE_URL}/travel/contact` },
