...
export type AbsenceRejectModalLabels = {
...
type Props = {
  ...
  onCancel: () => void;
  loading?: boolean;
  labels: AbsenceRejectModalLabels;
};

export function AbsenceRejectModal({ employeeName, onConfirm, onCancel, loading = false, labels }: Props) {
