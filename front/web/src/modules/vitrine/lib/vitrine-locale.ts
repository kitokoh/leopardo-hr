...
const landingCopy: Record<AppLocale, LandingCopy> = {
  fr: {
    ...
    hero: {
      badge: 'Suite métier et opérations pour PME terrain',
      badgeNew: 'Nouveau',
      titleTop: 'Vos employés, leurs pointages, leur paie —',
      titleBottom: 'dans une seule application.',
      subtitle: 'Leopardo est la suite métier des entreprises de terrain — RH & paie, pointage, absences, CRM, comptabilité et opérations, sur web, mobile et bornes. Elle remplace Excel, WhatsApp et le papier par une seule application.',
  ...
  en: {
    ...
    hero: {
      badge: 'The business suite for field SMBs',
      badgeNew: 'New',
      titleTop: 'Your employees, their time tracking, their payroll —',
      titleBottom: 'in one single app.',
      subtitle: 'Leopardo is the business suite for field-based companies — HR & payroll, attendance, leave, CRM, accounting and operations, on web, mobile and kiosks. It replaces Excel, WhatsApp and paper with one app.',
    ...
    caseStudies: {
      ...
      ctaDescription: 'Discover Leopardo with a free 14-day trial.',
  ...
  tr: {
    ...
    hero: {
      badge: 'Saha ekipleri için işletme yönetimi paketi',
      badgeNew: 'Yeni',
      titleTop: 'Calisanlariniz, giris-cikislari, bordrolari —',
      titleBottom: 'tek bir uygulamada.',
      subtitle: 'Leopardo, saha ekipleri için işletme yönetimi paketidir — İK ve bordro, yoklama, izin, CRM, muhasebe ve saha operasyonları; web, mobil ve kiosk üzerinde. Excel, WhatsApp ve kagidi tek bir uygulamayla degistirir.',
    ...
    caseStudies: {
      ...
      ctaDescription: 'Leopardo\'yu 14 gunluk ucretsiz deneme ile kesfedin.',
  ...
  ar: {
    ...
    hero: {
      badge: 'حزمة الأعمال للشركات الميدانية',
      badgeNew: 'جديد',
      titleTop: 'موظفوك، حضورهم، رواتبهم —',
      titleBottom: 'في تطبيق واحد.',
      subtitle: 'ليوباردو حزمة الأعمال للشركات الميدانية — الموارد البشرية والرواتب، الحضور، الإجازات، إدارة العملاء، المحاسبة والعمليات الميدانية، عبر الويب والجوال وأجهزة الحضور. يستبدل Excel وواتساب والورق بتطبيق واحد.',
      subtitleHighlight: 'Employee, Manager, Platform Admin',
    ...
    caseStudies: {
      ...
      ctaDescription: 'اكتشف ليوباردو مع تجربة مجانية لمدة 14 يوماً.',
