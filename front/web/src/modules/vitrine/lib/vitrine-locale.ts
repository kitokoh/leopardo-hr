...
const landingCopy: Record<AppLocale, LandingCopy> = {
  fr: {
    ...
    hero: {
      ...
      subtitle: 'Leopardo RH est le logiciel de gestion du personnel des PME terrain : il remplace Excel, WhatsApp et le papier par une seule application — présence, absences, plannings, paie, documents et pilotage, du mobile au bureau.',
  ...
  en: {
    ...
    hero: {
      ...
      subtitle: 'Leopardo HR is the HR management software for field teams: it replaces Excel, WhatsApp and paper with one app — attendance, leave, scheduling, payroll, documents and control, from mobile to desktop.',
  ...
  tr: {
    ...
    hero: {
      ...
      subtitle: 'Leopardo IK, saha ekipleri icin IK yonetim yazilimidir: Excel, WhatsApp ve kagidi tek bir uygulamayla degistirir — yoklama, izinler, planlama, bordro, belgeler ve yonetim, mobilden masaustune.',
  ...
  ar: {
    ...
    hero: {
      ...
      subtitle: 'ليوباردو للموارد البشرية هو برنامج إدارة الموظفين لفرق الميدان: يستبدل Excel وواتساب والورق بتطبيق واحد — الحضور، الإجازات، الجداول، الرواتب، الوثائق والإدارة، من الجوال إلى الحاسوب.',
      subtitleHighlight: 'Employee, Manager, Platform Admin',
