  ...
  fr: [
    {
      ...
      solution: 'Déploiement de bornes ZKTeco + module pointage Leopardo avec synchronisation automatique vers la paie.',
      results: [
  ...
  en: [
    {
      ...
      solution: 'Deployment of ZKTeco terminals + Leopardo attendance module with automatic payroll synchronization.',
      results: [
  ...
  tr: [
    {
      ...
      solution: 'ZKTeco terminalleri + maaş ile otomatik senkronizasyonlu Leopardo devam modülü.',
      results: [
  ...
  ar: [
    {
      ...
      solution: 'نشر أجهزة ZKTeco + وحدة الحضور في Leopardo مع مزامنة تلقائية مع الرواتب.',
      results: [
...
export const caseStudyUiCopy: Record<AppLocale, {
  ...
  fr: {
    ...
    moduleExplore: 'Découvrez comment Leopardo couvre ce besoin au quotidien, ou explorez les autres études de cas.',
    discoverModule: 'Découvrir {module}',
    ctaDescription: 'Rejoignez les entreprises qui ont choisi Leopardo',
  ...
  en: {
    ...
    moduleExplore: 'Discover how Leopardo covers this need day to day, or explore other case studies.',
    discoverModule: 'Discover {module}',
    ctaDescription: 'Join the companies that chose Leopardo',
  ...
  tr: {
    ...
    moduleExplore: 'Leopardo’nun bu ihtiyacı günlük olarak nasıl karşıladığını keşfedin veya diğer vaka çalışmalarına göz atın.',
    discoverModule: '{module} modülünü keşfedin',
    ctaDescription: 'Leopardo’yu seçen şirketlere katılın',
  ...
  ar: {
    ...
    moduleExplore: 'اكتشف كيف تغطي Leopardo هذه الحاجة يومياً، أو استكشف دراسات الحالة الأخرى.',
    discoverModule: 'اكتشف {module}',
    ctaDescription: 'انضم إلى الشركات التي اختارت Leopardo',
