...
const testimonialsByLocale: Record<AppLocale, Testimonial[]> = {
  fr: [
    ...
    },
    {
      ...
      content: "L'interface est intuitive et le support est excellent. Nos équipes l'ont adoptée très vite.",
      rating: 5,
    },
    {
      name: 'Fatou Sow',
      ...
      content: 'Le pointage biométrique et les anomalies manager ont changé notre discipline terrain.',
      rating: 5,
    },
    {
      name: 'Ibrahim Toure',
      ...
      company: 'BuildAfrica',
      content: 'Le mode hors ligne est crucial pour nos sites. La synchronisation automatique nous rassure énormément.',
      rating: 5,
    },
  ],
  en: [
