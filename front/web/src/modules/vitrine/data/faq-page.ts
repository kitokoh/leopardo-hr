...
const fr: FaqPageContent = {
  ...
  items: [
    ...
    { category: 'pricing', question: 'Comment fonctionne la tarification ?', answer: "Nous proposons des plans mensuels et annuels adaptés à la taille de votre équipe. Le plan Free est gratuit jusqu'à 5 employés, le plan Pilot démarre à 29 €/mois, le plan Operations inclut toutes les fonctionnalités avancées, et le plan Enterprise offre des options sur mesure." },
...
const en: FaqPageContent = {
  ...
  items: [
    ...
    { category: 'pricing', question: 'How does pricing work?', answer: 'We offer monthly and annual plans adapted to team size. The Free plan is free up to 5 employees, the Pilot plan starts at €29/month, the Operations plan includes all advanced features, and the Enterprise plan offers custom options.' },
...
const tr: FaqPageContent = {
  ...
  items: [
    ...
    { category: 'pricing', question: 'Fiyatlandırma nasıl çalışır?', answer: 'Ekip boyutuna uygun aylık ve yıllık planlar sunuyoruz. Free planı 5 çalışana kadar ücretsizdir, Pilot planı ayda 29 €\'dan başlar, Operations planı tüm gelişmiş özellikleri içerir ve Enterprise planı özel seçenekler sunar.' },
...
const ar: FaqPageContent = {
  ...
  items: [
    ...
    { category: 'pricing', question: 'كيف يعمل التسعير؟', answer: 'نقدم خططًا شهرية وسنوية تتكيف مع حجم فريقك. الخطة المجانية مجانية حتى 5 موظفين، وتبدأ خطة Pilot من 29 يورو/شهر، وتشمل خطة Operations جميع الميزات المتقدمة، وتقدم خطة Enterprise خيارات مخصصة.' },
