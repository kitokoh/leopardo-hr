...
const fr: FaqPageContent = {
  ...
  items: [
    ...
    { category: 'security', question: "Comment Leopardo RH m'aide-t-il à respecter le RGPD ?", answer: "Les données sont hébergées en Europe et nous fournissons les outils d'export et de suppression des données personnelles prévus par le RGPD. Leopardo RH ne détient pas de certification RGPD : la conformité dépend de votre usage et de votre organisation." },
...
const en: FaqPageContent = {
  ...
  items: [
    ...
    { category: 'security', question: 'How does Leopardo RH help me comply with GDPR?', answer: "Data is hosted in Europe and we provide the personal-data export and deletion tools required by GDPR. Leopardo RH is not GDPR-certified: compliance depends on your own usage and organisation." },
