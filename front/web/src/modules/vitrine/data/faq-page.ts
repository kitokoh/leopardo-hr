...
const fr: FaqPageContent = {
  ...
  items: [
    ...
    { category: 'pricing', question: 'Comment fonctionne la tarification ?', answer: "Nous proposons des plans mensuels et annuels adaptés à la taille de votre équipe. Le plan Starter démarre à 29 €/mois (20 employés inclus), le plan Business à 79 €/mois (200 employés inclus), et le plan Enterprise à 199 €/mois avec employés illimités et options sur mesure." },
    ...
    { category: 'support', question: 'Quel support est disponible ?', answer: "Le plan Starter inclut le support par email sous 48h. Le plan Business inclut le support prioritaire avec un temps de réponse sous 24h. Le plan Enterprise inclut un account manager dédié et un support 24/7." },
...
const en: FaqPageContent = {
  ...
  items: [
    ...
    { category: 'pricing', question: 'How does pricing work?', answer: 'We offer monthly and annual plans adapted to team size. The Starter plan starts at €29/month (20 employees included), the Business plan at €79/month (200 employees included), and the Enterprise plan at €199/month with unlimited employees and custom options.' },
    ...
    { category: 'support', question: 'What support is available?', answer: 'The Starter plan includes email support within 48h. The Business plan includes priority support with a response time under 24h. The Enterprise plan includes a dedicated account manager and 24/7 support.' },
...
const tr: FaqPageContent = {
  ...
  items: [
    ...
    { category: 'pricing', question: 'Fiyatlandırma nasıl çalışır?', answer: 'Ekip boyutuna uygun aylık ve yıllık planlar sunuyoruz. Starter planı ayda 29 €\'dan başlar (20 çalışan dahil), Business planı ayda 79 € (200 çalışan dahil), Enterprise planı ise ayda 199 € ile sınırsız çalışan ve özel seçenekler sunar.' },
    ...
    { category: 'support', question: 'Hangi destek mevcut?', answer: 'Starter planı 48 saat içinde e-posta desteği içerir. Business planı 24 saatten kısa yanıt süresiyle öncelikli destek içerir. Enterprise planı özel hesap yöneticisi ve 7/24 destek içerir.' },
...
const ar: FaqPageContent = {
  ...
  items: [
    ...
    { category: 'pricing', question: 'كيف يعمل التسعير؟', answer: 'نقدم خططًا شهرية وسنوية تتكيف مع حجم فريقك. تبدأ خطة Starter من 29 يورو/شهر (20 موظفًا مشمولين)، وخطة Business من 79 يورو/شهر (200 موظف مشمول)، وخطة Enterprise بسعر 199 يورو/شهر مع موظفين غير محدودين وخيارات مخصصة.' },
    ...
    { category: 'support', question: 'ما هو الدعم المتاح؟', answer: 'تشمل خطة Starter دعم البريد الإلكتروني خلال 48 ساعة. تشمل خطة Business الدعم ذا الأولوية بوقت استجابة أقل من 24 ساعة. تشمل خطة Enterprise مدير حساب مخصص ودعمًا على مدار الساعة.' },
