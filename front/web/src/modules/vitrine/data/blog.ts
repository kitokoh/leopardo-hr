...
Ce statut pilote signifie, concrètement : les barèmes IRG et les taux CNAS sont fournis, versionnés et testés, mais la validation finale de chaque cycle de paie reste de la responsabilité de votre gestionnaire de paie ou de votre expert-comptable. Nous ne promettons pas une conformité « validée » sur le plan réglementaire — personne ne peut sérieusement le faire à votre place — nous fournissons un moteur de calcul transparent, des exports de paie exploitables par votre comptable, et une traçabilité complète de chaque bulletin.
