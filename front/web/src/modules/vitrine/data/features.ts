...
const featuresByLocale: Record<AppLocale, Feature[]> = {
  fr: [
    ...
    },
    {
      ...
      stats: '21',
      statsLabel: 'Pays au catalogue',
      details: ['Multi-devises', 'Exports comptables', 'Avances sur salaire', 'Suivi des échéances fiscales'],
    },
    {
      icon: Shield,
      ...
      stats: 'UE',
      statsLabel: 'Hébergement',
      details: ['2FA', 'Chiffrement AES-256', "Journal d'audit", 'Outils RGPD (export, suppression)'],
    },
    {
      icon: Brain,
      title: 'Leo IA',
      description: 'Assistant IA pour analyser vos données RH, prioriser les anomalies et accélérer les décisions.',
      gradient: 'from-fuchsia-400 to-pink-500',
      stats: 'Option',
      statsLabel: 'Assistant IA',
      details: ['Analyse prédictive', 'Rapports automatiques', 'Synthèses manager', 'Suggestions intelligentes'],
    },
    {
      icon: Smartphone,
      title: 'Mobile first',
      description: 'Application iOS et Android avec synchronisation temps réel et mode hors ligne.',
      gradient: 'from-cyan-400 to-sky-500',
      stats: 'Beta',
      statsLabel: 'Accès testeurs',
      details: ['iOS & Android', 'Mode hors ligne', 'Push notifications', 'Expérience terrain'],
    },
  ],
  en: [
    {
    ...
    },
    {
      ...
      gradient: 'from-amber-400 to-orange-500',
      stats: '21',
      statsLabel: 'Countries in catalog',
    ...
    },
    {
      ...
      gradient: 'from-violet-400 to-purple-500',
      stats: 'EU',
      statsLabel: 'Hosted in Frankfurt',
  ...
  tr: [
    ...
    },
    {
      ...
      gradient: 'from-violet-400 to-purple-500',
      stats: 'AB',
      statsLabel: 'Frankfurt barindirma',
  ...
  ar: [
    ...
    },
    {
      ...
      gradient: 'from-violet-400 to-purple-500',
      stats: 'الاتحاد الأوروبي',
      statsLabel: 'استضافة فرانكفورت',
