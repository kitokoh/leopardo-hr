...
| Maroc | MA | 🟡 `pilot` | ✅ 3 cas (#2119) | ❌ | Abattement frais pro 35 % non implémenté (MA_COMPLIANCE.md) |
| Tunisie | TN | 🟡 `pilot` | ✅ 3 cas (#2119) | ❌ | Abattement 10 % non implémenté (TN_COMPLIANCE.md) |
...
| Canada | CA | 🟡 `pilot` | ✅ 3 cas (#2119) — fédéral seulement |
