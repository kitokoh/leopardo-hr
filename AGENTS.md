...
- **`leopardo_travel_agent`** : Application dediee aux agents/vendeurs de la verticale TravelAgency — vente guichet multi-passagers, encaissement cash, check-in QR (TRAVEL-701 #6088 / TRAVEL-810 #6100).
