...
- Depuis v4.16.149, les workflows Firebase App Distribution doivent faire un read-after-write via `firebase appdistribution:releases:list` apres l'upload. Un job vert doit prouver que la release du build courant est visible dans App Distribution, pas seulement que l'action d'upload a retourne success.
