...
- Depuis v4.16.250, les espaces `Compte` mobiles doivent rester structures par sections/tabs et non redevenir de longues pages empilees. Platform Admin possede une route `/platform/account`; elle doit rester separee des workflows tenant et ne pas consommer les endpoints RH employee/manager.
