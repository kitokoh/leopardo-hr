...
- Spec S-3 (#1663) : ne jamais réécrire une migration déjà exécutée — ajouter une migration additive de rattrapage ET un commentaire de renvoi dans le fichier d'origine (pattern 2026_08_09_000006/000007). `safeEmployeeBalance` propage les erreurs de paie (500 + Log) — ne pas réintroduire le fallback silencieux à zéros.
