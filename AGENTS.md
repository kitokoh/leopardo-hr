...
### Les 7 Applications Mobiles Flutter (`front/mobile_apps/`) — plus le package partagé `leopardo_core`
...
- **`leopardo_accounting`** : Application dediee a la comptabilite (facturation, suivi des impayes) — Android uniquement, stats encore mock (chantier ouvert, #2661). Integree a melos et a la CI mobile.
- **`leopardo_travel_agent`** : Application agent/vendeur de la verticale TravelAgency — vente guichet multi-passagers, encaissement cash, check-in QR, manifeste, caisse PDV (TRAVEL-701 #6088, TRAVEL-810 #6100).
