...
return [
    ...
    */
    ...
    // dev/test, le défaut reste 'sync' pour la simplicité locale. Utiliser
    // env() directement : app()->environment() n’est pas disponible pendant
    // le package:discover de Composer (#3769).
