...
class PlatformCompanyController extends Controller
{
    ...
    public function updateCountry(Request $request, string $companyId): RedirectResponse|JsonResponse
    {
        ...
        // partagé), or ce contrôleur s'exécute avec search_path=public →
        // bascule temporaire sur le schéma du tenant, puis restauration du
        // search_path ORIGINAL en `finally`.
