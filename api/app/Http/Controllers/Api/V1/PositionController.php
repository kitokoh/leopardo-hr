...
class PositionController extends Controller
{
    ...
    {
        return ['id' => $p->id, 'name' => $p->name, 'department_id' => $p->department_id, 'department' => $p->relationLoaded('department') && $p->department ? ['id' => $p->department->id, 'name' => $p->department->name] : null, 'created_at' => $p->created_at?->toIso8601String()];
    }
}
