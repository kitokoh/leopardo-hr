 ...
 *   3. exécution idempotente DANS le contexte du tenant de l'événement
 *      (un consommateur cross-tenant est structurellement refusé) ;
 *   4. succès → published (processed_at horodaté) ; erreur transitoire →
 *      retry avec backoff exponentiel (+jitter) ; erreur permanente ou
 *      attempts ≥ max → dead-letter (failed).
 *
