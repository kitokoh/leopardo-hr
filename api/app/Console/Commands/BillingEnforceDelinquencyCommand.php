...
class BillingEnforceDelinquencyCommand extends Command
{
    ...
    protected $description = 'Applique la politique de recouvrement : actif à période expirée → past_due, past_due hors grâce → expired (l\'enforcement d\'accès reste porté par companies.status).';
