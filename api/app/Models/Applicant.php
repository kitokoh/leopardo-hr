 ...
 * App\Models\Applicant continues to work unchanged during migration.
 *
 * ⚠️  DO NOT add logic here. Edit the canonical model in the module.
 * ✅  Once all usages are updated, delete this file.
 *
 * @deprecated Use App\Modules\Recruitment\Domain\Models\Applicant instead.
 */
...
if (! class_exists(\App\Models\Applicant::class, false)) {
    class_alias(
        \App\Modules\Recruitment\Domain\Models\Applicant::class,
