 ...
 * App\Models\TrainingSession continues to work unchanged during migration.
 *
 * ⚠️  DO NOT add logic here. Edit the canonical model in the module.
 * ✅  Once all usages are updated, delete this file.
 *
 * @deprecated Use App\Modules\HR\Domain\Models\TrainingSession instead.
 */
...
if (! class_exists(\App\Models\TrainingSession::class, false)) {
    class_alias(
        \App\Modules\HR\Domain\Models\TrainingSession::class,
