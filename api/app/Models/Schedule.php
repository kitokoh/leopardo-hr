 ...
 * App\Models\Schedule continues to work unchanged during migration.
 *
 * ⚠️  DO NOT add logic here. Edit the canonical model in the module.
 * ✅  Once all usages are updated, delete this file.
 *
 * @deprecated Use App\Modules\Planning\Domain\Models\Schedule instead.
 */
...
if (! class_exists(\App\Models\Schedule::class, false)) {
    class_alias(
        App\Modules\Planning\Domain\Models\Schedule::class,
