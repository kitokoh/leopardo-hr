 ...
 * App\Models\Vehicle continues to work unchanged during migration.
 *
 * ⚠️  DO NOT add logic here. Edit the canonical model in the module.
 * ✅  Once all usages are updated, delete this file.
 *
 * @deprecated Use App\Modules\Fleet\Domain\Models\Vehicle instead.
 */
...
if (! class_exists(\App\Models\Vehicle::class, false)) {
    class_alias(
        App\Modules\Fleet\Domain\Models\Vehicle::class,
