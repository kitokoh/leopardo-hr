...
/**
 * Création d'une cuve FuelStation (FUEL-011, #5805).
 *
 * Capacité en unités mineures entières (jamais de flottant métier),
 * strictement positive ; niveau courant optionnel (défaut 0).
 */
    ...
    public function rules(): array
    {
        ...
        return [
            'code' => [
                ...
                'string',
                'max:40',
                Rule::unique('fuel_tanks', 'code')->where(
            ...
            'capacity_minor' => ['required', 'integer', 'min:1'],
