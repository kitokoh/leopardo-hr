...
/**
 * Mise à jour d'un incident FuelStation (FUEL-010, #5804).
 * Seuls les champs descriptifs sont modifiables directement — le statut
 * évolue exclusivement via les endpoints de transition (assign/start/
 * resolve/close).
 */
