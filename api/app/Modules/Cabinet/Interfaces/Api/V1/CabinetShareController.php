...
class CabinetShareController extends Controller
{
    ...
    public function index(Request $request): JsonResponse
    {
        ...
        // #6674 : un shareable supprimé (orphelin historique) reste listé sans
        // 500 — serialize() null-guarde `shareable` et expose
        // `shareable_name: null`. Les types legacy sont déjà exclus par le
        // whereIn ci-dessus ; la purge à la suppression de la ressource
        // (révocation) est couverte par CabinetShareOrphanRegressionTest.
