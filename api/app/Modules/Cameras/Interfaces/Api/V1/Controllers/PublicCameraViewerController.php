...
class PublicCameraViewerController extends Controller
{
    ...
    {
        // #4931 + #6560 (audit sécurité F1) : le token ne voyage JAMAIS en
        // query string (fuite dans les logs proxy/CDN, Referer, historique).
        // Seul le header X-Token est accepté — le fallback ?t= a été
        // supprimé (les viewers doivent passer par l'en-tête).
