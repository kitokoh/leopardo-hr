...
final class AccountingSettingsDefaults
{
    ...
    private const TVA_RATES_BY_COUNTRY = [
        'DZ' => [
            ['label' => 'TVA standard', 'rate' => 19],
            ['label' => 'TVA réduite', 'rate' => 9],
        ],
        'MA' => [['label' => 'TVA standard', 'rate' => 20]],
        'TN' => [['label' => 'TVA standard', 'rate' => 19]],
        'SN' => [['label' => 'TVA standard', 'rate' => 18]],
        'CI' => [['label' => 'TVA standard', 'rate' => 18]],
        'ML' => [['label' => 'TVA standard', 'rate' => 18]],
        'BF' => [['label' => 'TVA standard', 'rate' => 18]],
        'BJ' => [['label' => 'TVA standard', 'rate' => 18]],
        'TG' => [['label' => 'TVA standard', 'rate' => 18]],
        'NE' => [['label' => 'TVA standard', 'rate' => 19]],
        'CM' => [['label' => 'TVA standard', 'rate' => 19.25]],
        'GA' => [['label' => 'TVA standard', 'rate' => 18]],
        'CG' => [['label' => 'TVA standard', 'rate' => 18.9]],
        'TD' => [['label' => 'TVA standard', 'rate' => 18]],
        'CF' => [['label' => 'TVA standard', 'rate' => 19]],
        'GQ' => [['label' => 'TVA standard', 'rate' => 15]],
        'FR' => [['label' => 'TVA standard', 'rate' => 20]],
        'TR' => [['label' => 'KDV standart', 'rate' => 20]],
        'GB' => [['label' => 'VAT standard', 'rate' => 20]],
