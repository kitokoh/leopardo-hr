...
/**
 * Ligne de vente comptoir d'officine — PHARMA-005 (#7802).
 *
 * Prix unitaire et taux de taxe FIGÉS au moment de la vente (un changement
 * ultérieur du référentiel produits ne réécrit jamais un ticket émis).
 *
 * @property int $id
