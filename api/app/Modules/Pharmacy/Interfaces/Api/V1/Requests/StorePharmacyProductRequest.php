...
/**
 * Création d'un produit d'officine — PHARMA-002 (#7799). Code-barres et code
 * interne uniques par tenant ; prix et taux positifs ou nuls.
 */
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'barcode' => [
                ...
                'string',
                'max:64',
                Rule::unique('pharmacy_products', 'barcode')->where(
            ...
            'internal_code' => [
                ...
                'string',
                'max:64',
                Rule::unique('pharmacy_products', 'internal_code')->where(
                    fn (Builder $query): Builder => $query->where('company_id', $actor?->company_id)
                ),
            ],
