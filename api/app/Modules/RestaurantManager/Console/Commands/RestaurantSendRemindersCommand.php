...
class RestaurantSendRemindersCommand extends Command
{
    ...
    protected $signature = 'restaurant:send-reminders {--window-hours=24 : fenetre de rappel avant reserved_at}';

    protected $description = 'Publie le rappel J-1 des reservations confirmees (idempotent, sans doublon).';
    ...
    public function handle(): int
    {
        ...
        $this->info("[restaurant:send-reminders] {$notified} rappel(s) publie(s).");
