...
class RestaurantNoShowExpireCommand extends Command
{
    ...
    protected $description = 'Marque no_show les reservations confirmees non honorees (idempotent).';
    ...
    public function handle(): int
    {
        ...
        $this->info("[restaurant:no-show-expire] {$updated} reservation(s) passee(s) en no_show.");
