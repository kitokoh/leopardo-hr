...
use Database\Factories\RestaurantOutboxEventFactory;
...
/**
 * #6178 (RESTO-213) — Événement d'outbox RestaurantManager (tenant-scoped).
 *
 ...
 */
class RestaurantOutboxEvent extends Model
{
    use BelongsToCompany;

    /** @use HasFactory<RestaurantOutboxEventFactory> */
    use HasFactory;
    ...
    protected $table = 'restaurant_outbox_events';
