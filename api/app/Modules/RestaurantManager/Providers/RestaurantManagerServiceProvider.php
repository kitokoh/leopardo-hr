...
class RestaurantManagerServiceProvider extends ServiceProvider
{
    ...
    {
        // Policies livraison, fidélité, promotions & réservations (RESTO-605..608, #6210-#6213).
        ...
        // Rapports & KPIs (RESTO-701/#6214, RESTO-703/#6216) : permission
        // `restaurant.reports` ouverte aux rôles opérationnels (manifest #6163).
        Gate::define('restaurant.reports', fn (Employee $actor): bool => $actor->hasManagerRole(
