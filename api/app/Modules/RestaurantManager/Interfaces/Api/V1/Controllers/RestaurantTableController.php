...
class RestaurantTableController extends Controller
{
    ...
    public function index(Request $request): JsonResponse
    {
        ...
        $tables = $this->scopeToAccessibleBranches($actor, RestaurantTable::query())
            ->orderBy('label')
            ->paginate($perPage);
    ...
    public function store(StoreRestaurantTableRequest $request): JsonResponse
    {
        ...
        if ($actor->cannot('create', [RestaurantTable::class, $request->validated()['branch_id'] ?? null])) {
            abort(403);
        }
    ...
    public function show(Request $request, RestaurantTable $restaurantTable): JsonResponse
    {
        ...
        if ($actor->cannot('view', $restaurantTable)) {
