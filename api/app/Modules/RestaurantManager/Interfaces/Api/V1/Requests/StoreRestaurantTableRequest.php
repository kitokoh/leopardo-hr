...
/**
 * RESTO-301 (#6182) — Validation stricte de création d'une table de salle.
 *
 * `branch_id` (obligatoire) et `zone_id` (optionnel) doivent référencer des
 * entités du tenant courant : les scopes `BelongsToCompany` filtrent
 * automatiquement les règles `exists` — une zone d'un autre tenant est
 * rejetée en 422. Le manager de salle (`manager`) est autorisé à créer des
...
class StoreRestaurantTableRequest extends FormRequest
{
    ...
    {
        return true; // RestaurantTablePolicy::create() tranche l'autorisation
    }
