...
/**
 * RESTO-301 (#6182) — Validation stricte de modification d'une zone de salle.
 *
 * `branch_id` doit référencer une succursale du tenant courant (scope
 * `BelongsToCompany` de `RestaurantBranch` sur la règle `exists`).
 * L'autorisation est tranchée par `RestaurantZonePolicy::update()`.
 */
class UpdateRestaurantZoneRequest extends FormRequest
{
    public function authorize(): bool
    {
        return true; // RestaurantZonePolicy::update() tranche l'autorisation
    }
