...
/**
 * Liste des leads CRM — Issue #5711 (CRM-V0-07).
 *
 * Filtres, tri et pagination strictement allowlistés : toute valeur hors
 * liste est refusée (422), jamais ignorée.
 */
class IndexCrmLeadRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'sort_by' => ['nullable', 'in:created_at,updated_at,first_name,last_name,email,status,priority'],
