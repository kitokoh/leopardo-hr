...
class HealthDepartmentPolicy
{
    ...
    public function view(Employee $actor, HealthDepartment $department): bool
    {
        return $department->company_id === $actor->company_id && $this->viewAny($actor);
    }
    ...
    public function update(Employee $actor, HealthDepartment $department): bool
    {
        return $department->company_id === $actor->company_id && HealthAccess::isAdmin($actor);
    }

    public function delete(Employee $actor, HealthDepartment $department): bool
    {
