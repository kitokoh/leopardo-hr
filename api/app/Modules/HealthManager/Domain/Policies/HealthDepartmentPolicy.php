...
/**
 * HC-002 (#7786) — Policy service médical (structure clinique, BC-30).
 *
...
class HealthDepartmentPolicy
{
    ...
    public function view(Employee $actor, HealthDepartment $resource): bool
    {
    ...
    public function update(Employee $actor, HealthDepartment $resource): bool
    {
        return $this->create($actor) && $resource->company_id === $actor->company_id;
    }

    public function delete(Employee $actor, HealthDepartment $resource): bool
    {
