...
class HealthPractitionerPolicy
{
    ...
    public function view(Employee $actor, HealthPractitioner $resource): bool
    {
    ...
    public function update(Employee $actor, HealthPractitioner $resource): bool
    {
        return $this->create($actor) && $resource->company_id === $actor->company_id;
    }

    public function delete(Employee $actor, HealthPractitioner $resource): bool
    {
