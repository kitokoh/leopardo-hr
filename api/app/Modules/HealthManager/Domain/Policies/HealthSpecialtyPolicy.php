...
/**
 * HC-002 (#7786) — Policy spécialité (structure clinique, BC-30).
 *
...
class HealthSpecialtyPolicy
{
    ...
    public function view(Employee $actor, HealthSpecialty $resource): bool
    {
    ...
    public function update(Employee $actor, HealthSpecialty $resource): bool
    {
        return $this->create($actor) && $resource->company_id === $actor->company_id;
    }

    public function delete(Employee $actor, HealthSpecialty $resource): bool
    {
