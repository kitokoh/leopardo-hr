...
/**
 * HC-002 (#7786) — Policy salle (structure clinique, BC-30).
 *
...
class HealthRoomPolicy
{
    ...
    public function view(Employee $actor, HealthRoom $resource): bool
    {
    ...
    public function update(Employee $actor, HealthRoom $resource): bool
    {
        return $this->create($actor) && $resource->company_id === $actor->company_id;
    }

    public function delete(Employee $actor, HealthRoom $resource): bool
    {
