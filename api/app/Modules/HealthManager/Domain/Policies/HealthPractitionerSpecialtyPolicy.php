 ...
 */
class HealthPractitionerSpecialtyPolicy
{
    ...
    public function view(Employee $actor, HealthPractitionerSpecialty $assignment): bool
    {
        return $assignment->company_id === $actor->company_id && $this->viewAny($actor);
    }
    ...
    public function update(Employee $actor, HealthPractitionerSpecialty $assignment): bool
    {
        return $assignment->company_id === $actor->company_id && HealthAccess::isAdmin($actor);
    }

    public function delete(Employee $actor, HealthPractitionerSpecialty $assignment): bool
    {
