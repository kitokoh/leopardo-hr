...
/**
 * Mise à jour d'un patient — HC-003 (#7787).
 *
 * Le MRN reste immuable (jamais accepté) ; le statut évolue via `status`
 * (active|deceased) — l'archivage passe par POST /archive, jamais par ici.
 */
class UpdateHealthPatientRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'sex' => ['sometimes', Rule::in(HealthPatient::SEXES)],
            ...
            'status' => ['sometimes', Rule::in([HealthPatient::STATUS_ACTIVE, HealthPatient::STATUS_DECEASED])],
        ];
    }
}
