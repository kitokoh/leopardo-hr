...
/**
 * Création d'un dossier patient (HC-003, #7787).
 *
 * Le MRN n'est JAMAIS accepté depuis la requête (généré côté serveur) ;
 * le tenant est TOUJOURS celui de l'acteur (BelongsToCompany).
 */
class StoreHealthPatientRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'sex' => ['nullable', Rule::in(['female', 'male', 'other', 'unknown'])],
            ...
            'status' => ['nullable', Rule::in(['active', 'deceased', 'archived'])],
        ];
    }
}
