...
class ProvisionGuidedTrial
{
    ...
    public function execute(
        ...
        $companyType = Company::normalizeCompanyType($companyType);
        $moduleSelection = Company::resolveModuleSelection($modules, $companyType);
        ...
        return DB::transaction(function () use ($email, $companyName, $slug, $countryDefaults, $solutions, $companyType, $moduleSelection, $language): array {
            $company = Company::query()->create([
                ...
                'features' => Company::mirroredFeatures($moduleSelection),
            ]);
