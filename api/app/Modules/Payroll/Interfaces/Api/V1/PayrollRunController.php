...
class PayrollRunController extends Controller
{
    ...
    public function calculate(Request $request, PayrollRun $payrollRun): JsonResponse
    {
        ...
        // Issue #2332/#1872 — un pays « placeholder » (CF/TD/GQ/TG/BJ/NE :
        // aucune valeur légale sourcée) ne peut pas alimenter un RUN réel sans
        // confirmation explicite, sinon des montants indicatifs seraient
        // présentés comme réels ; l'acceptation est AUDITÉE (tenant, pays,
        // acteur) — même garde et même pattern que les contrôleurs de
        // simulation (CotisationSimulationController / PayrollSimulationController).
        ...
        if ($rules->confidenceLevel() === 'placeholder') {
            ...
            AuditLog::create([
                ...
                'auditable_type' => 'App\Modules\Payroll\Infrastructure\Services\CountryRulesResolver',
                'auditable_id' => 0,
                'old_values' => [],
                'new_values' => [
