...
class SalaryStructureController extends Controller
{
    ...
    public function store(Request $request): JsonResponse
    {
        ...
        $validated = $request->validate([
            ...
            'country_code' => 'required|string|size:2|in:DZ,MA,TN,FR,TR,SN,CM,CF,TD,CG,GA,GQ,CA',
    ...
    public function update(Request $request, SalaryStructure $salaryStructure): JsonResponse
    {
        ...
        $validated = $request->validate([
            ...
            'country_code' => 'sometimes|string|size:2|in:DZ,MA,TN,FR,TR,SN,CM,CF,TD,CG,GA,GQ,CA',
