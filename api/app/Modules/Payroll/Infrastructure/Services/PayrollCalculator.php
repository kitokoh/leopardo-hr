...
class PayrollCalculator
{
    ...
    private PayrollWorkInputs $workInputs;
    ...
    public function __construct(
        ...
        // #5591 : agrégats d'entrées de travail extraits (dépendance optionnelle
        // pour préserver `new PayrollCalculator` dans les tests).
        ?PayrollWorkInputs $workInputs = null,
    ) {
        ...
        $this->workInputs = $workInputs ?? new PayrollWorkInputs;
    }
    ...
    private function executeCalculateRun(PayrollRun $run): PayrollRun
    {
        ...
        [$attendanceAgg, $leaveAgg] = $this->workInputs->aggregate($run, $employees);
    ...
    public function collectWorkInputs(
        ...
        // #5591 : délégué à PayrollWorkInputs (concern « requêtes
        // d'agrégation » extrait de PayrollCalculator).
        return $this->workInputs->collect($run, $employee, $attendanceAgg, $leaveAgg);
    }
