...
class CedeaoPayrollRules extends AbstractCountryRules
{
    ...
    {
        // BF (#1829) : CNSS Burkina Faso — retraite salarié 5,5 % + retraite
        // patronal 6,5 % + famille patronal 7,0 % plafonnés à 900 000
        // XOF/mois, AT patronal 3,5 % non plafonné (taux pilote).
        ...
        // ML (#1829) : INPS Mali — retraite salarié 3,6 % + retraite patronal
        // 7,4 % plafonnés à 3 000 000 XOF/mois, famille patronal 4,0 % et AT
        // patronal 2,0 % non plafonnés (taux pilote).
    ...
    {
        // BF (#1829) : IUTS Burkina Faso (CGI 2024) — tranches ANNUELLES,
        // taux « tout compris » (contribution communale incluse) —
        ...
        // ML (#1829) : ITS Mali (CGI 2024) — tranches ANNUELLES —
    ...
    {
        // BF (#1829) : CNSS Burkina Faso — retraite salariale 5,5 % +
        ...
        // ML (#1829) : INPS Mali — retraite salariale 3,6 % + patronale
    ...
    {
        // BF/ML (#1829) : préavis OHADA — niveau employé/technicien (1 mois) ;
        // ouvriers (8 jours) et cadres (3 mois) documentés dans
        // BF_COMPLIANCE.md §7 / ML_COMPLIANCE.md §7.
    ...
    {
        // BF (#1829) et ML (#1829) : IUTS/ITS + CNSS/INPS implémentés depuis
        // les sources légales publiques (CGI 2024) — niveau 'pilot' tant
        // qu'un expert-comptable local n'a pas validé les chiffres.
        ...
        return in_array($this->memberCountryCode, ['BF', 'ML', 'CI'], true) ? 'pilot' : 'placeholder';
    }
