...
{
    // Issue #7711 (suite #7646) — table `approval_requests` du schéma partagé
    // shared_tenants : company_id est l'unique frontière d'isolation. Le trait
    // scope les lectures et force company_id à l'écriture sous tenant actif.
