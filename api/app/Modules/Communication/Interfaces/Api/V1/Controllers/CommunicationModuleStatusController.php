        ...
        return new JsonResponse([
            'data' => [
                ...
                'capabilities' => [
                    ...
                    'classification' => true, // R3 (#7688) — classification IA + liaison CRM livrée
                    'follow_ups' => true,    // R4 (#7689) — relances automatiques livrées
                    'replies' => true,       // R5 (#7690) — réponses draft/confirm/auto livrées
                ],
            ],
        ]);
    }
