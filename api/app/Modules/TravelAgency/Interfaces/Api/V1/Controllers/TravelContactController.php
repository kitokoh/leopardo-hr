 ...
 *
 * La logique est partagée avec la route publique
 * `POST /public/travel/contact/{companySlug}` (TRAVEL-913/#6425) via
...
class TravelContactController extends Controller
{
    ...
    public function store(StoreTravelContactRequest $request): JsonResponse
    {
        ...
        $this->submit->execute($actor->company_id, $request->validated());
