...
class AuthServiceProvider extends ServiceProvider
{
    public function boot(): void
    {
        ...
        // — FuelStation FUEL-009 #5803 (stock) / FUEL-010 #5804 (incidents)
        Gate::policy(FuelTankStockLevel::class, FuelStockPolicy::class);
        Gate::policy(FuelStockDelivery::class, FuelStockPolicy::class);
        Gate::policy(FuelReconciliationReport::class, FuelStockPolicy::class);
        Gate::policy(FuelIncident::class, FuelIncidentPolicy::class);
        Gate::policy(FuelMaintenanceTask::class, FuelIncidentPolicy::class);
        Gate::policy(FuelIncidentAttachment::class, FuelIncidentPolicy::class);
