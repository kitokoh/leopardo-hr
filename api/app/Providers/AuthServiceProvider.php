...
use App\Modules\HealthManager\Domain\Policies\HealthInvoiceItemPolicy;
use App\Modules\HealthManager\Domain\Policies\HealthInvoicePaymentPolicy;
...
use App\Modules\HealthManager\Domain\Policies\HealthPractitionerSpecialtyPolicy;
use App\Modules\HealthManager\Domain\Policies\HealthPrescriptionItemPolicy;
...
use App\Modules\HospitalityManager\Domain\Policies\HospitalityPropertyStaffPolicy;
use App\Modules\HospitalityManager\Domain\Policies\HospitalityReservationPolicy;
...
class AuthServiceProvider extends ServiceProvider
{
    public function boot(): void
    {
        ...
        // HealthManager (BC-30) — deny-by-default (#7785)
        Gate::policy(HealthDepartment::class, HealthDepartmentPolicy::class);
        Gate::policy(HealthRoom::class, HealthRoomPolicy::class);
        Gate::policy(HealthBed::class, HealthBedPolicy::class);
        Gate::policy(HealthSpecialty::class, HealthSpecialtyPolicy::class);
        Gate::policy(HealthPractitioner::class, HealthPractitionerPolicy::class);
        Gate::policy(HealthPractitionerSpecialty::class, HealthPractitionerSpecialtyPolicy::class);
        Gate::policy(HealthStaffRole::class, HealthStaffRolePolicy::class);
        ...
        Gate::policy(HealthPrescriptionItem::class, HealthPrescriptionItemPolicy::class);
        ...
        // HOSP-003 (#7945) : équipe par établissement.
        Gate::policy(HospitalityPropertyStaff::class, HospitalityPropertyStaffPolicy::class);
        // HOSP-004 (#7946) : réservations.
        ...
        // — Pharmacy (PharmaManager, BC-30) — issue #8165 (PA2-ARCH-008)
