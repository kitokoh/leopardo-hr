...
return [
    ...
    // API responses (#3237)
    'RESET_LINK_SENT' => 'Bu e-posta için bir hesap varsa, bir sıfırlama bağlantısı gönderildi.',
    'INVALID_RESET_TOKEN' => 'Geçersiz, süresi dolmuş veya zaten kullanılmış sıfırlama jetonu.',
    ...
    'TWO_FA_ALREADY_ENABLED' => 'Bu hesap için 2FA zaten etkin.',
    ...
    'EVALUATION_ALREADY_EXISTS' => 'Bu dönem için bu çalışana ait bir değerlendirme zaten var.',
    'EVALUATION_ACKNOWLEDGED_IMMUTABLE' => 'Onaylanmış bir değerlendirme artık değiştirilemez.',
    'EVALUATION_DRAFT_ONLY_SUBMIT' => 'Yalnızca taslak değerlendirmeler gönderilebilir.',
    'EVALUATION_SUBMITTED_ONLY_ACK' => 'Yalnızca gönderilmiş değerlendirmeler onaylanabilir.',
    'EVALUATION_DRAFT_ONLY_DELETE' => 'Yalnızca taslak değerlendirmeler silinebilir.',
    'PAYROLL_RUN_VALIDATE_BEFORE_SEND' => 'Maaş dönemi gönderilmeden önce onaylanmalıdır.',
