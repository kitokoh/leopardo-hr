...
return [
    ...
    'TWO_FA_ALREADY_ENABLED' => '2FA is already enabled for this account.',
    ...
    'EVALUATION_ALREADY_EXISTS' => 'An evaluation already exists for this employee on this period.',
    'EVALUATION_ACKNOWLEDGED_IMMUTABLE' => 'An acknowledged evaluation can no longer be modified.',
    'EVALUATION_DRAFT_ONLY_SUBMIT' => 'Only a draft evaluation can be submitted.',
    'EVALUATION_SUBMITTED_ONLY_ACK' => 'Only a submitted evaluation can be acknowledged.',
    'EVALUATION_DRAFT_ONLY_DELETE' => 'Only a draft evaluation can be deleted.',
    'PAYROLL_RUN_VALIDATE_BEFORE_SEND' => 'The payroll run must be validated before sending.',
