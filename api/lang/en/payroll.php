...
return [
    ...
    'rate_submit_failed' => 'Submission failed. Check the validation rules and try again.',
    'rate_approve_failed' => 'Approval failed. Check the row state and try again.',
    'rate_reject_failed' => 'Rejection failed. Check the row state and try again.',
