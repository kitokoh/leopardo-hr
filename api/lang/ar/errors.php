...
return [
    ...
    // BC-30 HealthManager — HC-007 (#7791), فوترة الرعاية.
    'HEALTH_INVOICE_NOT_EDITABLE' => 'الفاتورة الصادرة لم تعد قابلة للتعديل (الإلغاء فقط).',
    'HEALTH_INVOICE_OVERPAYMENT' => 'الدفعة تتجاوز الرصيد المتبقي من الفاتورة.',
];
