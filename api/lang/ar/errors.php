...
return [
    ...
    'AI_CREDITS_EXHAUSTED' => 'نفدت أرصدة الذكاء الاصطناعي. اشترِ حزمة أرصدة من مساحة الفوترة للمتابعة.',
    'SERVICE_UNAVAILABLE' => 'الخدمة غير متوفرة مؤقتاً.',
    'RESTAURANT_ONLINE_PAYMENT_NOT_CONFIGURED' => 'الدفع عبر الإنترنت غير مُفعّل لهذا المطعم. يرجى الدفع في الموقع.',
    ...
    'SESSION_ALREADY_ACTIVE' => 'أنت مسجل الدخول بالفعل إلى مساحة عمل Leopardo. سجّل الخروج قبل إنشاء مساحة جديدة.',
    ...
    'TTS_UNAVAILABLE' => 'تحويل النص إلى صوت غير متاح مؤقتًا (الخدمة غير مكوّنة).',
