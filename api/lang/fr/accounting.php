...
return [
    ...
    'validation' => [
        ...
        'entry_ids_required' => 'Au moins une écriture est requise.',
        'entry_ids_integer' => 'Identifiants d\'écritures invalides.',
        'entry_ids_min' => 'Au moins une écriture est requise.',
        'letter_required' => 'La lettre de lettrage est requise.',
        'letter_max' => 'Lettre trop longue (max 20 caractères).',
        'period_required' => 'La période est requise.',
        'period_invalid' => 'Période invalide (format AAAA-MM).',
        'year_required' => 'L\'année est requise.',
        'year_integer' => 'Année invalide.',
        'year_between' => 'Année hors bornes autorisées.',
        'year_range' => 'Année invalide.',
    ],

    // Erreurs métier (issue #5227)
    'errors' => [
        'statement_period_invalid' => 'Période de relevé invalide.',
        'statement_year_invalid' => 'Année de relevé invalide.',
    ...
    'chart_account_has_entries' => 'Ce compte contient des écritures et ne peut pas être supprimé.',
    'chart_system_account_not_deletable' => 'Compte système non supprimable.',
    'fec_no_entries' => 'Aucune écriture sur la période.',
    'fiscal_year_already_closed' => 'Exercice déjà clôturé.',
    'lettering_already_used' => 'Lettrage déjà utilisé.',
    'lettering_invalid' => 'Lettrage invalide.',
    'lettering_unbalanced' => 'Lettrage non équilibré.',
];
