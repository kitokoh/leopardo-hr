...
return [
    ...
    // API responses (#3237)
    'RESET_LINK_SENT' => 'Si un compte existe pour cet email, un lien de réinitialisation a été envoyé.',
    'INVALID_RESET_TOKEN' => 'Jeton de réinitialisation invalide, expiré ou déjà utilisé.',
    'PASSWORD_RESET_SUCCESS' => 'Mot de passe réinitialisé. Connectez-vous avec votre nouveau mot de passe.',
    ...
    'TWO_FA_ALREADY_ENABLED' => 'Le 2FA est déjà activé pour ce compte.',
    ...
    'EVALUATION_ALREADY_EXISTS' => 'Une évaluation existe déjà pour cet employé sur cette période.',
    'EVALUATION_ACKNOWLEDGED_IMMUTABLE' => 'Une évaluation accusée de réception ne peut plus être modifiée.',
    'EVALUATION_DRAFT_ONLY_SUBMIT' => 'Seule une évaluation en brouillon peut être soumise.',
    'EVALUATION_SUBMITTED_ONLY_ACK' => 'Seule une évaluation soumise peut être accusée de réception.',
    'EVALUATION_DRAFT_ONLY_DELETE' => 'Seule une évaluation en brouillon peut être supprimée.',
    'PAYROLL_RUN_VALIDATE_BEFORE_SEND' => 'Le run de paie doit être validé avant envoi.',
