...
| `Modules/HealthManager` | ✅ routes/modules/health_manager.php | 🟢 verticale BC-31 (HC-001..008, pilote) | `HealthManagerServiceProvider` |
| `Modules/HospitalityManager` | ✅ routes/modules/hospitality_manager.php (squelette HOSP-001 : `GET /hospitality/status`) | 🔶 squelette BC-32 (HOSP-001 #7943) : manifest `hospitality`, feature flag fail-closed, sonde d'état — référentiel/équipe/réservations/locatif/vitrine aux lots HOSP-002→008 (spec `SOLUTION_HOSPITALITY.md`) | `HospitalityManagerServiceProvider` |
...
| `Modules/Pharmacy` | ✅ routes/modules/pharmacy.php | 🟢 verticale BC-31 MVP (PHARMA-001..007 : produits, stock FEFO par lots, achats, ventes comptoir, ordonnancier, dashboard) — Infrastructure vide (0 PHP) | `PharmacyServiceProvider` |
