...
@section('content')
    ...
    >
        ...
        <div class="grid gap-4 md:grid-cols-3">
            <x-stat-card label="Rôle" :value="$employee->role" />
        ...
        <div class="rounded-xl border border-slate-800 bg-slate-950/50 p-4 shadow">
            <div class="flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
                <div>
                    ...
                    <div class="text-xs text-slate-500">Période (jours ouvrés) + estimation net/gross.</div>
                </div>

                <div class="flex flex-wrap items-end gap-3">
                    <div>
                        <label class="text-xs text-slate-400">Début</label>
            ...
            <div class="mt-4" x-show="result">
                <div class="grid gap-4 md:grid-cols-3">
                    <div class="rounded-xl border border-slate-800 bg-slate-950/50 p-4 shadow">
                        <div class="text-xs font-medium uppercase tracking-wide text-slate-400">Jours présents</div>
