...
class NotificationTest extends TestCase
{
    ...
    {
        // Le constructeur du dispatcher exige désormais le service de push
        // (QA #2230 — câblage FCM) : mock injecté.
        $dispatcher = new NotificationDispatcher($this->createMock(PushNotificationService::class));
