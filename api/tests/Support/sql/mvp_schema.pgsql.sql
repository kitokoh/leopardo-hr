...
CREATE TABLE public.users (
    ...
    personal_onboarding_completed_at timestamptz NULL,
    job_search_preferences jsonb NULL,
    job_search_profile_updated_at timestamptz NULL,
    job_application_notifications jsonb NULL,
...
CREATE TABLE shared_tenants.employees (
    ...
    last_login_at timestamptz NULL,
    email_verified_at timestamptz NULL,
    email_bounced_at timestamptz NULL,
    email_bounce_reason varchar(255) NULL,
...
CREATE TABLE shared_tenants.salary_advances (
    ...
    dispute_resolved_by bigint NULL,
    dispute_resolution_note text NULL,
