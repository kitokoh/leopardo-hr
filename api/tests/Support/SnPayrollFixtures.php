...
final class SnPayrollFixtures
{
    ...
    public static function socialCharges(float $gross): array
    {
        return match ($gross) {
            ...
            // 36 288 + 62 208 + 4 410 + 630 + 64 800 = 168 336
            2160000.0 => ['employee' => 65664.0, 'employer' => 168336.0],
            // T2 plafonné à 2 160 000 → salariale 65 664 ; patronal
            // 36 288 + 62 208 + 4 410 + 630 + 90 000 = 193 536
            3000000.0 => ['employee' => 65664.0, 'employer' => 193536.0],
