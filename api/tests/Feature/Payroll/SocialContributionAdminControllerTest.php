...
class SocialContributionAdminControllerTest extends TestCase
{
    ...
    public function test_admin_mutations_write_audit_entries(): void
    {
        ...
        $this->assertSame(5.6, (float) ($updatedEntry->previous_value['rate'] ?? null));
        $this->assertSame(5.8, (float) ($updatedEntry->new_value['rate'] ?? null));
    ...
    public function test_admin_update_rejects_window_shrinking_onto_another_active_row(): void
    {
        ...
        // A reste intacte.
        $this->assertSame(5.6, (float) SocialContribution::query()->findOrFail((int) $a['id'])->getAttribute('rate'));
    }
}
