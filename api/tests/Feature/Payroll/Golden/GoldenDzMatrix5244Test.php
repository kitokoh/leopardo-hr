...
class GoldenDzMatrix5244Test extends TestCase
{
    ...
    public static function fullSlipProvider(): array
    {
        ...
        return [
            ...
            // +29 200×30 % = 30 160 → annuel 361 920 → abattement 18 000 →
            // 28 660 · net 80 540 · patronale 31 200 · coût 151 200.
            'cadre 120 000' => [120000.0, 10800.0, 109200.0, 28660.0, 80540.0, 31200.0, 151200.0],
    ...
    public static function irgAbatementProvider(): array
    {
        ...
        return [
            ...
            // 90 000 : 4 600+10 800+10 000×30 % = 14 600 → annuel 175 200 →
            // abattement 18 000 → (175 200−18 000)/12 = 13 100.
            '90 000 (tranche 30 %)' => [90000.0, 13100.0],
            // 130 000 : 4 600+10 800+50 000×30 % = 30 300 → annuel 363 600 →
            // abattement 18 000 → (363 600−18 000)/12 = 28 800.
            '130 000' => [130000.0, 28800.0],
    ...
    public static function primesProvider(): array
    {
        ...
        return [
            ...
            // 34 334 · CNAS 3 090,06 · assiette 31 243,94 · IRG 4 600+
            // 11 243,94×27 % = 7 635,8638 → annuel 91 630,3656 → abattement
            // 18 000 → 6 135,86 · net 25 108,08 · patronale 8 926,84 ·
            // coût 43 260,84.
            'arrondi composite 34 334' => [34334.0, 3090.06, 31243.94, 6135.86, 25108.08, 8926.84, 43260.84],
        ];
    }
