...
class GoldenCiPayrollTest extends TestCase
{
    ...
    public static function itsasProvider(): array
    {
        return [
            ...
            // + 630 000 + 1 225 000 + 1 059 200 × 27 % = 2 168 984 → mensuel 180 748,67
            'tranche 27 % (10M–25M)'          => [1200000.0, 38400.0, 180748.67],
            // 2 900 000 − 52 714,08 (plafonné 1 647 315 × 3,2 %) − 580 000 (20 %)
            // = 2 267 285,92 → annuel 27 207 431,04 → 28 000 + 630 000 + 1 225 000
            // + 15 000 000 × 27 % = 4 050 000 + 2 207 431,04 × 30 % = 662 229,31
            // → 6 595 229,31 → mensuel 549 602,44
            'tranche 30 % (> 25M)'            => [2900000.0, 52714.08, 549602.44],
        ];
    }
