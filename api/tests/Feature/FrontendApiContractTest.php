...
class FrontendApiContractTest extends TestCase
{
    ...
    public static function criticalFrontendRoutes(): array
    {
        return [
            ...
            'mobile manager payroll payment documents' => ['GET', 'api/v1/payments/{payrollRun}/documents'],
            ...
            'mobile notification read' => ['PATCH', 'api/v1/notifications/{notification}/read'],
            'mobile notifications read all' => ['POST', 'api/v1/notifications/read-all'],
            ...
            'admin payroll run calculate' => ['POST', 'api/v1/payroll-runs/{payrollRun}/calculate'],
            'admin payroll run validate' => ['POST', 'api/v1/payroll-runs/{payrollRun}/validate'],
            'admin pay slips list' => ['GET', 'api/v1/pay-slips'],
            'admin pay slip pdf' => ['GET', 'api/v1/pay-slips/{paySlip}/pdf'],
            'admin absence approve' => ['PUT', 'api/v1/absences/{absence}/approve'],
            'admin absence reject' => ['PUT', 'api/v1/absences/{absence}/reject'],
            ...
            'crm client pipelines list' => ['GET', 'api/v1/crm/pipelines'],
            'crm client pipeline create' => ['POST', 'api/v1/crm/pipelines'],
            'crm client pipeline detail' => ['GET', 'api/v1/crm/pipelines/{crmPipeline}'],
            'crm client pipeline update' => ['PATCH', 'api/v1/crm/pipelines/{crmPipeline}'],
            'crm client pipeline delete' => ['DELETE', 'api/v1/crm/pipelines/{crmPipeline}'],
            'crm client stages list' => ['GET', 'api/v1/crm/pipelines/{crmPipeline}/stages'],
            'crm client stage create' => ['POST', 'api/v1/crm/pipelines/{crmPipeline}/stages'],
            'crm client stage update' => ['PATCH', 'api/v1/crm/pipelines/{crmPipeline}/stages/{crmPipelineStage}'],
            'crm client stage delete' => ['DELETE', 'api/v1/crm/pipelines/{crmPipeline}/stages/{crmPipelineStage}'],
            'crm client leads list' => ['GET', 'api/v1/crm/leads'],
            'crm client lead create' => ['POST', 'api/v1/crm/leads'],
            'crm client lead detail' => ['GET', 'api/v1/crm/leads/{crmLead}'],
            'crm client lead update' => ['PATCH', 'api/v1/crm/leads/{crmLead}'],
            'crm client lead delete' => ['DELETE', 'api/v1/crm/leads/{crmLead}'],
            'crm client opportunities list' => ['GET', 'api/v1/crm/opportunities'],
            'crm client opportunity create' => ['POST', 'api/v1/crm/opportunities'],
            'crm client opportunity detail' => ['GET', 'api/v1/crm/opportunities/{crmOpportunity}'],
            'crm client opportunity update' => ['PATCH', 'api/v1/crm/opportunities/{crmOpportunity}'],
            'crm client opportunity delete' => ['DELETE', 'api/v1/crm/opportunities/{crmOpportunity}'],
            'crm client activities list' => ['GET', 'api/v1/crm/activities'],
            'crm client activity create' => ['POST', 'api/v1/crm/activities'],
            'crm client tasks list' => ['GET', 'api/v1/crm/tasks'],
            'crm client task create' => ['POST', 'api/v1/crm/tasks'],
            'crm client task detail' => ['GET', 'api/v1/crm/tasks/{crmTask}'],
            'crm client task update' => ['PATCH', 'api/v1/crm/tasks/{crmTask}'],
            'crm client task delete' => ['DELETE', 'api/v1/crm/tasks/{crmTask}'],
            ...
            'admin user show' => ['GET', 'api/v1/admin/users/{user}'],
            'admin user update' => ['PATCH', 'api/v1/admin/users/{user}'],
