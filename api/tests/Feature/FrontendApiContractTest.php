...
class FrontendApiContractTest extends TestCase
{
    ...
    public static function criticalFrontendRoutes(): array
    {
        return [
            ...
            'mobile manager payment batch create' => ['POST', 'api/v1/payment-batches'],
            'mobile manager payment batch detail' => ['GET', 'api/v1/payment-batches/{paymentBatch}'],
            'mobile manager payment batch mark paid' => ['POST', 'api/v1/payment-batches/{paymentBatch}/mark-paid'],
            'mobile employee payment confirmation' => ['POST', 'api/v1/payment-confirmations/{paymentItem}/confirm'],
