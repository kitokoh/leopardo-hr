...
class FrontendApiContractTest extends TestCase
{
    ...
    public static function criticalFrontendRoutes(): array
    {
        return [
            ...
            // QA #2201 : un seul chemin canonique — /payments/{payrollRun}/documents (contrat mobile).
            'mobile manager payments documents' => ['GET', 'api/v1/payments/{payrollRun}/documents'],
