...
class SalaryAdvanceSecurityTest extends TestCase
{
    ...
    public function test_manager_cannot_list_salary_advances_from_another_company(): void
    {
    ...
    public function test_employee_can_only_list_their_own_salary_advances(): void
    {
    ...
    public function test_manager_cannot_access_salary_advance_from_another_company(): void
    {
        $companyA = $this->createCompany('Company A');
        $companyB = $this->createCompany('Company B');
    ...
    public function test_employee_cannot_approve_salary_advance(): void
    {
        $company = $this->createCompany('Company A');
        ...
        $response = $this->actingAs($employee, 'sanctum')
            ->putJson("/api/v1/salary-advances/{$advance->id}/approve", [
                'decision_comment' => 'Self approval',
            ]);
