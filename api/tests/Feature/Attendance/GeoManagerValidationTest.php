...
class GeoManagerValidationTest extends TestCase
{
    ...
    public function test_manager_can_reject_pending_session(): void
    {
        ...
        $response = $this->postJson("/api/v1/attendance/sessions/{$session->id}/reject", [
    ...
    public function test_approve_updates_attendance_log_method_to_geo_auto(): void
    {
        ...
        $this->postJson("/api/v1/attendance/sessions/{$session->id}/approve", [
            'note' => 'OK',
        ])->assertStatus(200);
    ...
    public function test_manager_cannot_approve_cross_tenant_session(): void
    {
        ...
        $response = $this->postJson("/api/v1/attendance/sessions/{$foreignSession->id}/approve", [
