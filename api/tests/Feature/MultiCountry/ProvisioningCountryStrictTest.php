...
class ProvisioningCountryStrictTest extends TestCase
{
    ...
    public function test_country_defaults_find_is_strict_no_dz_fallback(): void
    {
        ...
        // PHPStan Strict : find() retourne array{...}|null — accès via ?? pour
        // lever l'offset sur union nullable, l'assertSame garde la rigueur.
        $this->assertSame('CI', CountryDefaults::find('ci')['country'] ?? null);
