...
class EmployeeDocumentTest extends TestCase
{
    ...
    public function test_dossier_badge_ignores_missing_status_rows(): void
    {
        ...
        // Une ligne « missing » ne satisfait pas le type requis : ni
        // contract_signed ni employee_file ne sont présents → les deux
        // restent dans la liste `missing` (contrat unique #5356, service OK).
