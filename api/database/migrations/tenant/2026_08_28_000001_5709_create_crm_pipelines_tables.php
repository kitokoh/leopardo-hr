...
/**
 * Issue #5709 — CRM client V0 : pipelines + stages.
 *
 ...
 *   - `company_id` (UUID) sur chaque ligne — isolation tenant stricte ;
 ...
 *     pour les stages : impossible de rattacher un stage d'un pipeline d'un
