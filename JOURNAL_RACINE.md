...
| 2026-05-10 | Jules (Contractor) | API/Mobile Contract Hardening | `api/`, `mobile/`, `CHANGELOG.md`, `PILOTAGE.md`, `api/config/app.php` | Durcissement des contrats API/Mobile (devise imbriquée, champs d'estimation attendance) et synchronisation de version v4.1.120 |
