...
| 2026-05-08 | DocKeeper | Synchronisation version v4.1.119 | `PILOTAGE.md`, `CHANGELOG.md`, `api/config/app.php`, `docs/README.md`, `JOURNAL_RACINE.md` | Synchronisation de PROGRAM_VERSION a 4.1.119 et alignement des dates de mise a jour pour la stabilite de la beta. |
